...
public partial class ASPXTestplanSelfInfor : BasePage
{
    ...
    public void bindData()
    {
        ...
        for (byte i = 0; i < testTestplanSelfInfor.Length; i++)
        {
            ...
            testTestplanSelfInfor[i].TH13Text = mydt.Columns["PNCheck"].ColumnName;
            testTestplanSelfInfor[i].TH14Text = mydt.Columns["SWCheck"].ColumnName;
            testTestplanSelfInfor[i].TH10Text = mydt.Columns["IgnoreFlag"].ColumnName;
            testTestplanSelfInfor[i].TH11Text = mydt.Columns["ItemDescription"].ColumnName;
            testTestplanSelfInfor[i].TH12Text = mydt.Columns["Version"].ColumnName;
