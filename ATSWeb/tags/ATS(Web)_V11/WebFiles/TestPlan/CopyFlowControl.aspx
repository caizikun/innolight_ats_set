<%@ Page Title="" Language="C#" MasterPageFile="~/a_MasterPage.master" AutoEventWireup="true" CodeFile="CopyFlowControl.aspx.cs" Inherits="ASPXCopyFlowControl" %>
<%@ Register src="../../Frame/TestPlan/CopyFlowControl.ascx" tagname="CopyFlowControl" tagprefix="uc1" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server" AsyncPostBackTimeout="0">
   ...
   <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Always" runat="server">
    	...
    	<tr>
    		<td>            
             <asp:PlaceHolder ID="AddNewFlowControl" Runat="Server" ></asp:PlaceHolder> 
            </td>
    	</tr>   
</table>
                 </ContentTemplate>
