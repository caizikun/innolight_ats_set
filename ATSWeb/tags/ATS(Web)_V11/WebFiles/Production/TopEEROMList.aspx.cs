    ...
    public void ConfigPageNumber(ASCXTopE2ROMList input,string ItemID)
    {
        try
        {
            switch (ModuleTypeName)
            {
                ...
                case "SFF8472":
                    {
                        input.PostBackUrlStringData0 = "~/WebFiles/Production/E2ROMDataInfor.aspx?PageNumber=4&uId=" + ItemID;
                        input.PostBackUrlStringData1 = "~/WebFiles/Production/E2ROMDataInfor.aspx?PageNumber=5&uId=" + ItemID;
