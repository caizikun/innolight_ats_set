...
{
    const string funcItemName = "FuncBlockList";
    ...
    public WebFiles_UserRoleFunc_FuncList()
    {
    ...
    bool getInfo(string filterStr)
    {
        ...
        try
        {
            ...
            for (int i = 0; i < myDt.Rows.Count; i++)
            {
                ...
                ControlList[i].ConfigLinkPostBackURL = "~/WebFiles/UserRoleFunc/FuncBlockInfo.aspx?uId=" + myDt.Rows[i]["ID"];
                ...
                ControlList[i].ConfigLinkPostBackURL2 = "~/WebFiles/UserRoleFunc/BlockAscxInfo.aspx?uId=" + myDt.Rows[i]["ID"];
    ...
    {
        Response.Redirect("~/WebFiles/UserRoleFunc/FuncBlockInfo.aspx?AddNew=true", true);
        return true;
    }
