...
public partial class WebFiles_UserRoleFunc_UserList : BasePage
{
        ...
        try
        {
            ...
            {                                   
                ...
                for (int i = 0; i < pReaderTable.Rows.Count; i++)
                {
                    ...
                    ControlList[i].ConfigLinkPostBackURL = "~/WebFiles/UserRoleFunc/UserInfo.aspx?uId=" + pReaderTable.Rows[i]["ID"];


                    ControlList[i].ConfigLink2Text = "View";
                    ControlList[i].ConfigLinkPostBackURL2 = "~/WebFiles/UserRoleFunc/UserRoleInfo.aspx?uId=" + pReaderTable.Rows[i]["ID"];
                    ...
                    {                        
                        ControlList[i].ConfigLinkPostBackURL3 = "~/WebFiles/UserRoleFunc/UserActionInfo.aspx?uId=" + pReaderTable.Rows[i]["ID"] + "&uActionType=" + ActionType;
                    }
    ...
    {
        Response.Redirect("~/WebFiles/UserRoleFunc/UserInfo.aspx?AddNew=true", true);
        return true;
    }
