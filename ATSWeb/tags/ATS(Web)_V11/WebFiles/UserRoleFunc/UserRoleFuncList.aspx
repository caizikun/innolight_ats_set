<%@ Page Title="" Language="C#" MasterPageFile="~/a_MasterPage.master" AutoEventWireup="true"  EnableEventValidation="false" CodeFile="UserRoleFuncList.aspx.cs" Inherits="WebFiles_UserRoleFunc_UserRoleFuncList" %>
<%@ Register src="../../Frame/OptionButtons.ascx" tagname="OptionButtons" tagprefix="uc3" %>


<%@ Register src="../../Frame/UserRoleFunc/RolefunctionList.ascx" tagname="functionList" tagprefix="uc1" %>
