<%@ Page Title="" Language="C#" MasterPageFile="~/a_MasterPage.master" AutoEventWireup="true" EnableEventValidation="false"  CodeFile="AscxFileList.aspx.cs" Inherits="WebFiles_UserRoleFunc_AscxFileList" %>
<%@ Register src="../../Frame/OptionButtons.ascx" tagname="OptionButtons" tagprefix="uc3" %>
<%@ Register src="../../Frame/UserRoleFunc/ascxFileList.ascx" tagname="functionList" tagprefix="uc1" %>
