...
{   
    ...
    #endregion
#region LinButtonEnable
    public bool Data0LinkButtonEn
    {
        get
        {
            return LinkButtonData0.Enabled;
        }
        set
        {
            LinkButtonData0.Enabled = value;
        }
    }
    public bool Data1LinkButtonEn
    {
        get
        {
            return LinkButtonData1.Enabled;
        }
        set
        {
            LinkButtonData1.Enabled = value;
        }
    }
    public bool Data2LinkButtonEn
    {
        get
        {
            return LinkButtonData2.Enabled;
        }
        set
        {
            LinkButtonData2.Enabled = value;
        }
    }
    public bool Data3LinkButtonEn
    {
        get
        {
            return LinkButtonData3.Enabled;
        }
        set
        {
            LinkButtonData3.Enabled = value;
        }
    }
