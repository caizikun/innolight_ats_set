...
public partial class userInfo : System.Web.UI.UserControl
{
    ...
    #endregion
    public string btnChangePwdTxt
    {
        get { return btnChangePWD.Text; }
        set
        {
            btnChangePWD.Text = value;
        }
    }
    ...
    public string hlkUserImageUrl
    {
        get { return hlkUserID.ImageUrl; }
        set
        {
            hlkUserID.ImageUrl = value;
        }
    }


    public string hlkUserNavigateUrl
    {
        get { return hlkUserID.NavigateUrl; }
        set
        {
            hlkUserID.NavigateUrl = value;
        }
    }
