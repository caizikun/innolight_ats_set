...
<div>
    ...
    <th  width="130px" ID="TH2Title" class="tHStyleLeft" runat="server" >
        <asp:Label ID="TH2" runat="server" Text="Name"></asp:Label>
    </th>
    <th width="130px" ID="TH3Title" class="tHStyleLeft" runat="server" >
        <asp:Label ID="TH3" runat="server" Text="Role"></asp:Label>
    </th>
     <th  width="130px" ID="TH4Title" class="tHStyleLeft" runat="server">
        <asp:Label ID="TH4" runat="server" Text="Direction"></asp:Label>
    </th>
     <th  width="130px" ID="TH5Title" class="tHStyleLeft" runat="server">
        <asp:Label ID="TH5" runat="server" Text="ChannelMap"></asp:Label>
    </th>
    ...
    <td class="tdLeft" width="130px" style="border:solid #000 1px"><asp:LinkButton ID="LinkBChannelMapControl" runat="server">View</asp:LinkButton>
     </td>
