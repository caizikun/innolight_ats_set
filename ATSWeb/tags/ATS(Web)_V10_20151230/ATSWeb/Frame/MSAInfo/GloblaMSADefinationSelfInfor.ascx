...
<tr>
   ...
   <td style="position:relative;">
    ...
    <asp:TextBox ID="Colum2Text" width="182px" height="14px" onkeydown="Colum2TextEnter()" runat="server" style="position:absolute; margin-left:-209px;"></asp:TextBox>
   </td>
   <td>
...
<tr>
    ...
    <td>
     <asp:TextBox ID="Colum8Text" width="200px" onkeydown="Colum8TextEnter()" runat="server"></asp:TextBox>
    </td>
    <td>
