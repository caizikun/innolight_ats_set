<%@ Page Title="" Language="C#" MasterPageFile="~/a_MasterPage.master" AutoEventWireup="true" EnableEventValidation="false"  CodeFile="AscxFileInfo.aspx.cs" Inherits="WebFiles_UserRoleFunc_AscxFileInfo" %>
<%@ Register src="../../Frame/OptionButtons.ascx" tagname="OptionButtons" tagprefix="uc3" %>
<%@ Register src="../../Frame/UserRoleFunc/ascxFileInfo.ascx" tagname="ascxFileInfo" tagprefix="uc1" %>
