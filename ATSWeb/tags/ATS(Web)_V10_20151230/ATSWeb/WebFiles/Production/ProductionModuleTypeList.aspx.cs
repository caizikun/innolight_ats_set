...
{
    const string funcItemName = "ProductionTypeList";
    ...
    public ASPXProductionModuleTypeList()
    {
        rowCount = 0;
    ...
    public void bindData()
    {
        ...
        if (rowCount==0)
        {
            ...
            for (byte i = 0; i < testModuleTypeSelfInfor.Length; i++)
            {
                ...
                testModuleTypeSelfInfor[i].TH2TEXT = "MSAName";
                //testModuleTypeSelfInfor[i].TH3TEXT = mydt.Columns[3].ColumnName;
                testModuleTypeSelfInfor[i].TH4TEXT = "PN";
        ...
        else
        {
            ...
            for (byte i = 0; i < testModuleTypeSelfInfor.Length; i++)
            {
                ...
                testModuleTypeSelfInfor[i].PostBackUrlString = "~/WebFiles/Production/ModuleTypeSelfInfor.aspx?AddNew=false&uId=" + mydt.Rows[i]["ID"].ToString().Trim();
                ...
                testModuleTypeSelfInfor[i].PostBackUrlStringPN = "~/WebFiles/Production/ProductionPNList.aspx?uId=" + mydt.Rows[i]["ID"].ToString().Trim();
                ...
                if (i >= 1)
                {
                    testModuleTypeSelfInfor[i].EnabelTH4Visible = false;
    ...
    public bool connectDataBase()
    {
        try
        {
            if (pDataIO.OpenDatabase(true))
            {
                ...
                Control myCtrl = pCtrl.CreateNaviCtrl(funcItemName, "ProductionInfo", Session["BlockType"].ToString(), pDataIO,out logTracingString);
    ...
    public bool AddData(object obj, string prameter)
    {
        try
        {
            Response.Redirect("~/WebFiles/Production/ModuleTypeSelfInfor.aspx?AddNew=true&uId=0");
    ...
    public bool DeleteData(object obj, string prameter)
    {
        ...
        try
        {
            ...
            int result = pDataIO.UpdateWithProc("GlobalProductionType", mydt, deletStr, logTracingString);
            if (result > 0)
            {
                mydt.AcceptChanges();
            }
