...
{
    const string funcItemName = "ManageGlobalSpecsList";
    ...
    public WebFiles_GlobalSpecs_GlobalSpecsList()
    {
    ...
    bool getInfo(string filterStr)
    {
        ...
        try
        {
            ...
            for (int i = 0; i < drs.Length; i++)
            {
                ...
                ControlList[i].LnkItemNamePostBackUrl = "~/WebFiles/GlobalSpecs/GlobalSpecsInfo.aspx?uId=" + drs[i]["ID"];
    ...
    {
        Response.Redirect("~/WebFiles/GlobalSpecs/GlobalSpecsInfo.aspx?AddNew=true", true);
        return true;
    }
    ...
    public void ConfigOptionButtonsVisible()
    {
        ...
        OptionButtons1.ConfigBtAddVisible = mCommCtrl.CheckLoginAccess(CommCtrl.FunctionName.ConfigSpecs, CommCtrl.CheckAccess.EditConfigSpecs, myAccessCode);
        ...
        {
            OptionButtons1.ConfigBtDeleteVisible = mCommCtrl.CheckLoginAccess(CommCtrl.FunctionName.ConfigSpecs, CommCtrl.CheckAccess.EditConfigSpecs, myAccessCode);
        }
