...
{
    const string funcItemName = "EquipParamsList";
    ...
    public WebFiles_Equipment_EquipParamsList()
    {
           ...
           if (mydt.Rows.Count == 0)
            ...
            else
            {
                ...
                for (int i = 0; i < mydt.Rows.Count; i++)
                {
                    ...
                    ControlList[i].LnkItemPostBackUrl = "~/WebFiles/Equipment/CurrEquipParamInfo.aspx?uId=" + mydt.Rows[i]["ID"].ToString();
    ...
    {
        Response.Redirect("~/WebFiles/Equipment/CurrEquipParamInfo.aspx?AddNew=true&EquipId=" + this.EquipID);
        return true;
    }
