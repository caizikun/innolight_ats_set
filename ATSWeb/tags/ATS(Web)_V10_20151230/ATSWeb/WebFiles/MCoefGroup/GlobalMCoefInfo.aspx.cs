...
{
    const string funcItemName = "MCoefInfo";
    ...
    public WebFiles_MCoefGroup_GlobalMCoefInfo()
    {
    ...
    public bool SaveData(object obj, string prameter)
    {
        try
        {
            if (mydt.Rows.Count == 1)
            {
                ...
                {
                    mydt.AcceptChanges();
                    Response.Redirect("~/WebFiles/MCoefGroup/GlobalMCoefList.aspx?uId=" + TypeID, true);
                }
                else
                {
            ...
            else if (AddNew && mydt.Rows.Count == 0)
            {
                ...
                if (result > 0)
                {
                    ...
                    mydt.AcceptChanges();
                    Response.Redirect("~/WebFiles/MCoefGroup/CurrMCoefParamInfo.aspx?AddNew=true&MCoefID=" + MCoefID, true);
                }
                else
                {
                    pDataIO.AlertMsgShow("Update data fail!", Request.Url.ToString());
