<%@ Page Title="" Language="C#" MasterPageFile="~/a_MasterPage.master" AutoEventWireup="true" CodeFile="RegisterList.aspx.cs" Inherits="WebFiles_Chip_RegisterList" %>
<%@ Register src="../../Frame/OptionButtons.ascx" tagname="OptionButtons" tagprefix="uc1" %>
<%@ Register src="../../Frame/Chip/RegisterList.ascx" tagname="RegisterList" tagprefix="uc2" %>
...
<table border="0" cellspacing="0" > 
    	<tr valign="middle">
            <td id="PNContent0" >  
               <asp:PlaceHolder ID="Register_List" Runat="Server" ></asp:PlaceHolder> 
            </td>
    	</tr>
    </table> 
    <table margin="10px">
