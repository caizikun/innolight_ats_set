...
namespace ATSDataBase
{
    public class SqlManager : ServerDatabaseIO
    {
        ...
        //@TracingInfo	nvarchar(max)		
        //@myErr	int	OUTPUT	
        private int Pro_GlobalAllTestModelList(int id, int pid, string itemName, string showName, string itemDescription, int itemPriority,
            byte rowStatus, int opLogPID, string TracingInfo, out int myErr)
        {
            ...
            try
            {
                ...
                command.Parameters.Add(new SqlParameter("@ShowName", SqlDbType.NVarChar, 30));
                command.Parameters.Add(new SqlParameter("@ItemDescription", SqlDbType.NVarChar, 50));
                command.Parameters.Add(new SqlParameter("@ItemPriority", SqlDbType.Int));
                ...
                command.Parameters["@ShowName"].Value = showName;
                command.Parameters["@ItemDescription"].Value = itemDescription;
                command.Parameters["@ItemPriority"].Value = itemPriority;
        ...
        #region Pro_GlobalTestModelRelation
        //存储过程 Pro_GlobalTestModelRelation			
        //保存_GlobalTestModelRelation的资料			
        //参数	类型	方向	描述
        //@ID	int	OUTPUT	
        //@PID	int		
        //@ConflictID	int	
        ...
        //@TracingInfo	nvarchar(max)		
        //@myErr	int	OUTPUT	
        private int Pro_GlobalTestModelRelation(int id, int pid, int conflictID,
            byte rowStatus, int opLogPID, string TracingInfo, out int myErr)
        {
            myErr = -1; string errMsg = ""; SqlCommand command = new SqlCommand("Pro_GlobalTestModelRelation", conn);
            try
            {
                OpenDatabase(true);
                //执行存储过程 
                ...
                command.Parameters.Add(new SqlParameter("@ID", SqlDbType.Int));
                command.Parameters.Add(new SqlParameter("@PID", SqlDbType.Int));
                command.Parameters.Add(new SqlParameter("@ConflictID", SqlDbType.Int));
                ...
                command.Parameters["@ID"].Value = id;
                command.Parameters["@PID"].Value = pid;
                command.Parameters["@ConflictID"].Value = conflictID;
        ...
        //@TracingInfo	nvarchar(max)		
        //@myErr	int	OUTPUT	
        private int Pro_GlobalManufactureCoefficients(int id, int pid, string itemTYPE, string itemName, byte channel, byte page, int startAddress, byte length, string format,float amplifyCoeff,
            byte rowStatus, int opLogPID, string TracingInfo, out int myErr)
        {
            ...
            try
            {
                ...
                command.Parameters.Add(new SqlParameter("@AmplifyCoeff", SqlDbType.Float));
                ...
                command.Parameters["@Length"].Value = length;
                command.Parameters["@Format"].Value = format;
                command.Parameters["@AmplifyCoeff"].Value = amplifyCoeff;
        ...
        private int Pro_GlobalProductionName(int id, int pid, string pn, string itemName, byte channels, byte voltages,
            ...
            byte apc_Type, byte ber, byte maxRate, string publish_PN, string nickName, string ibiasFormula, string iModFormula, bool usingCelsiusTemp, float rxOverLoadDBm, bool wsFlag, 
            byte rowStatus, int opLogPID, string TracingInfo, out int myErr)    // byte apcStyle,
        {
            ...
            try
            {
                ...
                command.Parameters.Add(new SqlParameter("@wsFlag", SqlDbType.Bit));
                ...
                command.Parameters["@wsFlag"].Value = wsFlag;
        ...
        //@TracingInfo	nvarchar(max)		
        //@myErr	int	OUTPUT	
        private int Pro_GlobalManufactureChipsetInitialize(int id, int pid,string ItemName, byte driveType, byte chipLine,
        ...
        #region Pro_TopoManufactureChipsetInitialize
        //存储过程 Pro_TopoManufactureChipsetInitialize			
        //保存_TopoManufactureChipsetInitialize的资料			
        //参数	类型	方向	描述
        //@ID	int	OUTPUT	
        //@PID	int		
        //@DriveType	tinyint		
        ...
        //@TracingInfo	nvarchar(max)		
        //@myErr	int	OUTPUT	
        private int Pro_TopoManufactureChipsetInitialize(int id, int pid,string ItemName, byte driveType, byte chipLine,
            int registerAddress, byte length, int itemValue, bool endianness,
            byte rowStatus, int opLogPID, string TracingInfo, out int myErr)
        {
            myErr = -1; string errMsg = ""; SqlCommand command = new SqlCommand("Pro_TopoManufactureChipsetInitialize", conn);
            try
            {
                OpenDatabase(true);
                //执行存储过程 
        ...
        private int Pro_GlobalManufactureChipsetControl(int id, int pid, string itemName, byte moduleLine, byte chipLine, byte driveType,
            int registerAddress, byte length, bool endianness,int startBit,int endBit,
            byte rowStatus, int opLogPID, string TracingInfo, out int myErr)
        {
        ...
        private int Pro_TopoTestPlan(int id, int pid, string itemName, string swVersion, string hwVersion, byte usbPort, bool isChipInitialize,
            bool isEEPROMInitialize, bool ignoreBackupCoef, bool snCheck, bool swCheck, bool pnCheck, bool ignoreFlag, string itemDescription, bool isCDROn,
            byte rowStatus, int opLogPID, string TracingInfo, out int myErr)
        {
            ...
            try
            {
                ...
                command.Parameters.Add(new SqlParameter("@SWCheck", SqlDbType.Bit));
                command.Parameters.Add(new SqlParameter("@PNCheck", SqlDbType.Bit));
                command.Parameters.Add(new SqlParameter("@IgnoreFlag", SqlDbType.Bit));
                command.Parameters.Add(new SqlParameter("@ItemDescription", SqlDbType.NVarChar, 50));
                command.Parameters.Add(new SqlParameter("@IsCDROn", SqlDbType.Bit));
                ...
                command.Parameters["@SWCheck"].Value = swCheck;
                command.Parameters["@PNCheck"].Value = pnCheck;
                command.Parameters["@IgnoreFlag"].Value = ignoreFlag;
                command.Parameters["@ItemDescription"].Value = itemDescription;
                command.Parameters["@IsCDROn"].Value = isCDROn;
        ...
        //@TracingInfo	nvarchar(max)		
        //@myErr	int	OUTPUT	
        private int Pro_TopoManufactureConfigInit(int id, int pid,string ItemName, int slaveAddress, byte page, int startAddress, byte length, int itemValue,
            byte rowStatus, int opLogPID, string TracingInfo, out int myErr)
        {
        ...
        #region Pro_ReportHeader
        //存储过程 Pro_ReportHeader		
        //保存_ReportHeader的资料			
        //参数	类型	方向	描述
        //@ID	int	OUTPUT	
        //@ItemName	nvarchar(50)			
        ...
        //@TracingInfo	nvarchar(max)		
        //@myErr	int	OUTPUT	
        private int Pro_ReportHeader(int id, string itemName, string Description,
            byte rowStatus, int opLogPID, string TracingInfo, out int myErr)
        {
            myErr = -1; string errMsg = ""; SqlCommand command = new SqlCommand("Pro_ReportHeader", conn);
            try
            {
                OpenDatabase(true);
                //执行存储过程 
        ...
        #region Pro_ReportHeaderSpecs
        //存储过程 Pro_ReportHeaderSpecs	
        //保存_ReportHeaderSpecs的资料			
        //参数	类型	方向	描述
        //@ID	int	OUTPUT	
        //@PID	int		
        //@SpecID	int		
        ...
        //@TracingInfo	nvarchar(max)		
        //@myErr	int	OUTPUT	
        private int Pro_ReportHeaderSpecs(int id, int pid, int SpecId, string ShowName, int Seq,
            byte rowStatus, int opLogPID, string TracingInfo, out int myErr)
        {
            myErr = -1; string errMsg = ""; SqlCommand command = new SqlCommand("Pro_ReportHeaderSpecs", conn);
            try
            {
                OpenDatabase(true);
                //执行存储过程 
                //SqlCommand command = new SqlCommand("Pro_ReportHeaderSpecs", conn);
                //说明命令要执行的是存储过程     
                command.CommandType = CommandType.StoredProcedure;
                //向存储过程中传递参数   
                command.Parameters.Add(new SqlParameter("@ID", SqlDbType.Int));
                command.Parameters.Add(new SqlParameter("@PID", SqlDbType.Int));
                command.Parameters.Add(new SqlParameter("@SpecID", SqlDbType.Int));
                command.Parameters.Add(new SqlParameter("@ShowName", SqlDbType.NVarChar, 150));
                command.Parameters.Add(new SqlParameter("@Seq", SqlDbType.Int));
                ...
                command.Parameters["@ID"].Value = id;
                command.Parameters["@PID"].Value = pid;
                command.Parameters["@SpecID"].Value = SpecId;
                command.Parameters["@ShowName"].Value = ShowName;
                command.Parameters["@Seq"].Value = Seq;
            ...
            string tracingInfo, string databaseName)
        {
            ...
            try
            {
                ...
                if (dt.GetChanges() != null)
                {
                    ...
                    #region "ATS_V2"
                    if (databaseName.ToUpper().Trim() == "ATS_V2" || databaseName.ToUpper().Trim() == "ATS_VXDEBUG")
                    {
                        ...
                        else if (tableName.Trim().ToUpper() == "GlobalAllTestModelList".ToUpper())
                        {
                            ...
                            if (tempDt != null)
                            {
                                foreach (DataRow dr in tempDt.Rows)
                                {
                                    int id; int pid; string itemName; string showName; string itemDescription; int itemPriority;
                                    byte rowState = 1;
                                    ...
                                    if (dr.RowState == DataRowState.Deleted)
                                    {
                                        ...
                                        itemDescription = dr["ItemDescription", DataRowVersion.Original].ToString();
                                        itemPriority = Convert.ToInt32(dr["ItemPriority", DataRowVersion.Original]);
                                        rowState = 2;
                                    }
                                    else
                                    {
                                        ...
                                        itemDescription = dr["ItemDescription"].ToString();
                                        itemPriority = Convert.ToInt32(dr["ItemPriority"]);
                                    }
                                    result = Pro_GlobalAllTestModelList(id, pid, itemName,showName, itemDescription,itemPriority,
                                        rowState, opLogPID, tracingInfo, out myErr);
                                    if (myErr != 0)
                                    {
                                        break;
                        ...
                        else if (tableName.Trim().ToUpper() == "GlobalTestModelRelation".ToUpper())
                        {
                            #region  Pro_GlobalTestModelRelation
                            ...
                            if (tempDt != null)
                            {
                                foreach (DataRow dr in tempDt.Rows)
                                {
                                    ...
                                    if (dr.RowState == DataRowState.Deleted)
                                    {
                                        id = Convert.ToInt32(dr["ID", DataRowVersion.Original]);
                                        pid = Convert.ToInt32(dr["pid", DataRowVersion.Original]);
                                        conflictID = Convert.ToInt32(dr["conflictID", DataRowVersion.Original]);
                                        rowState = 2;
                                    }
                                    else
                                    {
                                        ...
                                        id = Convert.ToInt32(dr["ID"]);
                                        pid = Convert.ToInt32(dr["pid"]);
                                        conflictID = Convert.ToInt32(dr["conflictID"]);
                                    }
                                    result = Pro_GlobalTestModelRelation(id, pid, conflictID,
                                        rowState, opLogPID, tracingInfo, out myErr);
                                    if (myErr != 0)
                                    {
                                        break;
                            ...
                            if (tempDt != null)
                            {
                                foreach (DataRow dr in tempDt.Rows)
                                {
                                    ...
                                    if (dr.RowState == DataRowState.Deleted)
                                    {
                                        ...
                                        wsFlag = Convert.ToBoolean(dr["wsFlag", DataRowVersion.Original]);
                                        rowState = 2;
                                    }
                                    else
                                    {
                                        ...
                                        wsFlag = Convert.ToBoolean(dr["wsFlag"]);
                                    }
                                    result = Pro_GlobalProductionName(id, pid, pn, itemName, channels, voltages, tsensors, mCoefsID, ignoreFlag,
                                        oldDriver,  tec_Present, couple_Type, apc_Type, ber, maxRate, publish_PN, nickName, ibiasFormula, iModFormula, usingCelsiusTemp, rxOverLoadDBm, wsFlag,
                        ...
                        else if (tableName.Trim().ToUpper() == "GlobalManufactureChipsetInitialize".ToUpper())
                        {
                            ...
                            if (tempDt != null)
                            {
                                foreach (DataRow dr in tempDt.Rows)
                                {
                                    int id; int pid; string ItemName; byte driveType; byte chipLine;
                                    int registerAddress; byte length; int itemValue; bool endianness;
                                    ...
                                    result = Pro_GlobalManufactureChipsetInitialize(id, pid,ItemName,driveType, chipLine, registerAddress, length, itemValue, endianness,
                                        rowState, opLogPID, tracingInfo, out myErr);
                                    if (myErr != 0)
                                    {
                                        break;
                        ...
                        else if (tableName.Trim().ToUpper() == "TopoManufactureChipsetInitialize".ToUpper())
                        {
                            #region Pro_TopoManufactureChipsetInitialize
                            //private int Pro_GlobalManufactureChipsetInitialize(int id, int pid,string ItemName, byte driveType, byte chipLine,
                            //int registerAddress, byte length, int itemValue, bool endianness,
                            ...
                            if (tempDt != null)
                            {
                                foreach (DataRow dr in tempDt.Rows)
                                {
                                    ...
                                    result = Pro_TopoManufactureChipsetInitialize(id, pid,ItemName,driveType, chipLine, registerAddress, length, itemValue, endianness,
                                        rowState, opLogPID, tracingInfo, out myErr);
                                    if (myErr != 0)
                                    {
                                        break;
                        ...
                        else if (tableName.Trim().ToUpper() == "GlobalManufactureChipsetControl".ToUpper())
                        {
                            ...
                            if (tempDt != null)
                            {
                                foreach (DataRow dr in tempDt.Rows)
                                {
                                    ...
                                    result = Pro_GlobalManufactureChipsetControl(id, pid, itemName, moduleLine, chipLine, driveType, registerAddress, length, endianness,startBit,endBit,
                                        rowState, opLogPID, tracingInfo, out myErr);
                                    if (myErr != 0)
                                    {
                                        break;
                            ...
                            if (tempDt != null)
                            {
                                foreach (DataRow dr in tempDt.Rows)
                                {
                                    ...
                                    if (dr.RowState == DataRowState.Deleted)
                                    {
                                        ...
                                        swCheck = Convert.ToBoolean(dr["swCheck", DataRowVersion.Original]);
                                        pnCheck = Convert.ToBoolean(dr["pnCheck", DataRowVersion.Original]);                                        
                                        ignoreFlag = Convert.ToBoolean(dr["ignoreFlag", DataRowVersion.Original]);
                                        itemDescription = dr["itemDescription", DataRowVersion.Original].ToString();
                                        isCDROn = Convert.ToBoolean(dr["isCDROn", DataRowVersion.Original]); 
                                        rowState = 2;
                                    }
                                    else
                                    {
                                        ...
                                        swCheck = Convert.ToBoolean(dr["swCheck"]);
                                        pnCheck = Convert.ToBoolean(dr["pnCheck"]);
                                        ignoreFlag = Convert.ToBoolean(dr["ignoreFlag"]);
                                        itemDescription = dr["itemDescription"].ToString();
                                        isCDROn = Convert.ToBoolean(dr["isCDROn"]);
                                    }
                                    result = Pro_TopoTestPlan(id, pid, itemName, swVersion, hwVersion, usbPort,
                                        isChipInitialize, isEEPROMInitialize, ignoreBackupCoef, snCheck, swCheck, pnCheck, ignoreFlag, itemDescription,isCDROn,
                                        rowState, opLogPID, tracingInfo, out myErr);
                                    if (myErr != 0)
                                    {
                                        break;
                        ...
                        else if (tableName.Trim().ToUpper() == "TopoManufactureConfigInit".ToUpper())
                        {
                            ...
                            if (tempDt != null)
                            {
                                foreach (DataRow dr in tempDt.Rows)
                                {
                                    int id; int pid; string ItemName; int slaveAddress; byte page; int startAddress; byte length; int itemValue;
                                    ...
                                    result = Pro_TopoManufactureConfigInit(id, pid,ItemName, slaveAddress, page, startAddress, length, itemValue,
                                        rowState, opLogPID, tracingInfo, out myErr);
                                    if (myErr != 0)
                                    {
                                        break;
                        ...
                        else if (tableName.Trim().ToUpper() == "GlobalManufactureCoefficients".ToUpper())
                        {
                            ...
                            if (tempDt != null)
                            {
                                foreach (DataRow dr in tempDt.Rows)
                                {
                                    ...
                                    byte channel; byte page; int startAddress; byte length; string format; float amplifyCoeff;
                                    ...
                                    if (dr.RowState == DataRowState.Deleted)
                                    {
                                        ...
                                        length = Convert.ToByte(dr["length", DataRowVersion.Original]);
                                        format = dr["format", DataRowVersion.Original].ToString();
                                        amplifyCoeff = Convert.ToSingle(dr["amplifyCoeff", DataRowVersion.Original]);
                                        rowState = 2;
                                    }
                                    else
                                    {
                                        ...
                                        length = Convert.ToByte(dr["length"]);
                                        format = dr["format"].ToString();
                                        amplifyCoeff = Convert.ToSingle(dr["amplifyCoeff"]);
                                    }
                                    result = Pro_GlobalManufactureCoefficients(id, pid, itemTYPE, itemName, channel, page, startAddress, length, format, amplifyCoeff,
                                        rowState, opLogPID, tracingInfo, out myErr);
                                    if (myErr != 0)
                                    {
                                        break;
                        ...
                        else if (tableName.Trim().ToUpper() == "ReportHeader".ToUpper())
                        {
                            #region  Pro_ReportHeader
                            //private int Pro_ReportHeader(int id, string itemName, string description,
                            //byte rowStatus, int opLogPID, string TracingInfo, out int myErr)
                            if (tempDt != null)
                            {
                                foreach (DataRow dr in tempDt.Rows)
                                {
                                    int id; string itemName; string description;
                                    ...
                                    if (dr.RowState == DataRowState.Deleted)
                                    {
                                        id = Convert.ToInt32(dr["ID", DataRowVersion.Original]);
                                        itemName = dr["itemName", DataRowVersion.Original].ToString();
                                        description = dr["description", DataRowVersion.Original].ToString();
                                        rowState = 2;
                                    }
                                    else
                                    {
                                    ...
                                    result = Pro_ReportHeader(id, itemName, description,
                                        rowState, opLogPID, tracingInfo, out myErr);
                                    if (myErr != 0)
                                    {
                                        break;
                        ...
                        else if (tableName.Trim().ToUpper() == "ReportHeaderSpecs".ToUpper())
                        {
                            #region  Pro_ReportHeaderSpecs
                            //private int Pro_ReportHeader(int id, int pid, int SpecId,int Seq,
                            //byte rowStatus, int opLogPID, string TracingInfo, out int myErr)
                            if (tempDt != null)
                            {
                                foreach (DataRow dr in tempDt.Rows)
                                {
                                    int id; int pid; int SpecId; String ShowName; int Seq;
                                    ...
                                    if (dr.RowState == DataRowState.Deleted)
                                    {
                                        id = Convert.ToInt32(dr["ID", DataRowVersion.Original]);
                                        pid = Convert.ToInt32(dr["PID", DataRowVersion.Original]);
                                        SpecId = Convert.ToInt32(dr["SpecID", DataRowVersion.Original]);
                                        ShowName = dr["ShowName", DataRowVersion.Original].ToString();
                                        Seq = Convert.ToInt32(dr["Seq", DataRowVersion.Original]);
                                        rowState = 2;
                                    }
                                    ...
                                    result = Pro_ReportHeaderSpecs(id, pid, SpecId, ShowName, Seq,
                                        rowState, opLogPID, tracingInfo, out myErr);
                                    if (myErr != 0)
                                    {
                                        break;
        ...
        #region Pro_CopyMCoef
        //存储过程 Pro_CopyMCoef			
        //复制模块系数的资料			
        //参数	类型	方向	描述
        //@sourceMCoefID int,
        //@NewMCoefName	nvarchar(30),
        //@NewMCoefDescription	nvarchar(200),
        //@NewMCoefPID	int,
        //@OPlogPID	int,
        //@TracingInfo nvarchar(max),
        //@myErr	nvarchar(max)	OUTPUT,
        //@myErrMsg	nvarchar(max)	OUTPUT
        private int Pro_CopyMCoef(int sourceMCoefID, string newMCoefName, string NewMCoefDescription, int newMCoefPID,
           int opLogPID, string TracingInfo, out string errMsg)
        {
            int myErr = -1;
            errMsg = "";
            SqlCommand command = new SqlCommand("Pro_CopyMCoef", conn);
            try
            {
                OpenDatabase(true);
                //执行存储过程 
                ...
                command.Parameters.Add(new SqlParameter("@SourceMCoefID", SqlDbType.Int, 50));
                command.Parameters.Add(new SqlParameter("@NewMCoefName", SqlDbType.NVarChar, 50));
                command.Parameters.Add(new SqlParameter("@NewMCoefDescription", SqlDbType.NVarChar, 200));
                command.Parameters.Add(new SqlParameter("@NewMCoefPID", SqlDbType.Int));
                command.Parameters.Add(new SqlParameter("@OPlogPID", SqlDbType.Int));
                command.Parameters.Add(new SqlParameter("@TracingInfo", SqlDbType.NVarChar, 4000));
                command.Parameters.Add(new SqlParameter("@myErr", SqlDbType.Int));
                command.Parameters.Add(new SqlParameter("@myErrMsg", SqlDbType.NVarChar, 4000));
                command.UpdatedRowSource = UpdateRowSource.None;
                command.Parameters["@SourceMCoefID"].Value = sourceMCoefID;
                command.Parameters["@NewMCoefPID"].Value = newMCoefPID;
                command.Parameters["@NewMCoefName"].Value = newMCoefName;
                command.Parameters["@NewMCoefDescription"].Value = NewMCoefDescription;
        ...
        public override int CopyMCoef(int sourceMCoefID, string newMCoefName, string NewMCoefDescription, int newMCoefPID, string tracingInfo, out string errMsg)
        {
            int result = -1;
            int opLogPID = -1;
            errMsg = "";
            try
            {
                ...
                #region  Pro_CopyMCoef
                result = Pro_CopyMCoef(sourceMCoefID, newMCoefName, NewMCoefDescription, newMCoefPID, opLogPID, tracingInfo, out errMsg);
                #endregion
