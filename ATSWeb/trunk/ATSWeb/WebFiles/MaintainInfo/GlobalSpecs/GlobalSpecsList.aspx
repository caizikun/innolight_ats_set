<%@ Page Title="" Language="C#" AutoEventWireup="true"  EnableEventValidation="false" CodeFile="GlobalSpecsList.aspx.cs" Inherits="WebFiles_GlobalSpecs_GlobalSpecsList" %>

<%@ Register src="~/Frame/GlobalSpecs/GlobalSpecsList.ascx" tagname="GlobalSpecsList" tagprefix="uc1" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="规格列表"></asp:Label>
 </div>
