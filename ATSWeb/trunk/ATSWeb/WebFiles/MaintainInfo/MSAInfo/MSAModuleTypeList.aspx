<%@ Page Title="" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="MSAModuleTypeList.aspx.cs" Inherits="ASPXMSAModuleTypeList" %>

<%@ Register src="~/Frame/MSAInfo/MSAModuleTypeList.ascx" tagname="ModuleType" tagprefix="uc1" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="MSA类型列表"></asp:Label>
 </div>
...
<table border="0" cellspacing="0" > 
    	<tr valign="middle">
            <td id="ModuleTypeContent0">                
             <asp:PlaceHolder ID="msamodutype"  Runat="Server" ></asp:PlaceHolder> 
            </td>
    	</tr>
    </table> 
