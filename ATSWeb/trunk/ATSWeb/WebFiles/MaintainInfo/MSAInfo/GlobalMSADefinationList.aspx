<%@ Page Title="" Language="C#" AutoEventWireup="true" EnableEventValidation="false"  CodeFile="GlobalMSADefinationList.aspx.cs" Inherits="ASPXGlobalMSADefinationList" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="MSA定义列表"></asp:Label>
 </div>
