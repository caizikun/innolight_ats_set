<%@ Page Title="" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="GlobalMSASelfInfor.aspx.cs" Inherits="ASPXGlobalMSASelfInfor" %>

<%@ Register src="~/Frame/OptionButtons.ascx" tagname="OptionButtons" tagprefix="uc1" %>
<%@ Register src="~/Frame/MSAInfo/MSASelfInfor.ascx" tagname="MSASelfInfor" tagprefix="uc2" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="MSA信息"></asp:Label>
 </div>
...
<asp:ScriptManager ID="ScriptManager1" runat="server" AsyncPostBackTimeout="0">
  ...
  <table border="0" cellspacing="2" cellpadding="0" width="100%">        
    	<tr>
    		<td> 
             <asp:PlaceHolder ID="GlobalMSASelfInfor" Runat="Server" ></asp:PlaceHolder> 
            </td>
    	</tr>   
</table>
</ContentTemplate>
