<%@ Page Title="" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="ReportHeaderList.aspx.cs" Inherits="ASPXReportHeaderList" %>

<%@ Register src="~/Frame/TestReport/ReportHeaderList.ascx" tagname="ReportHeader" tagprefix="uc1" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="报表表头列表"></asp:Label>
 </div>
 ...
 <table border="0" cellspacing="0">
    	<tr valign="middle">
            <td id="ModuleTypeContent0">                
             <asp:PlaceHolder ID="headerList" Runat="Server" ></asp:PlaceHolder> 
            </td>
    	</tr>
    </table>  
