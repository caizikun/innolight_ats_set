<%@ Page Title="" Language="C#" AutoEventWireup="true"  EnableEventValidation="false" CodeFile="ReportHeaderSpecsEdit.aspx.cs" Inherits="ReportHeaderSpecsEdit" %>

<%@ Register src="~/Frame/OptionButtons.ascx" tagname="OptionButtons" tagprefix="uc3" %>
<%@ Register src="~/Frame/TestReport/ReportHeaderSpecsEditList.ascx" tagname="ReportHeaderSpecsEditList" tagprefix="uc4" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="全表头规格项列表"></asp:Label>
 </div>
