<%@ Page Title="" Language="C#" AutoEventWireup="true"  EnableEventValidation="false" CodeFile="ReportHeaderSelfInfor.aspx.cs" Inherits="ASPXReportHeaderSelfInfor" %>

<%@ Register src="~/Frame/TestReport/ReportHeaderInfo.ascx" tagname="ReportHeaderInfo" tagprefix="uc1" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="报表表头信息"></asp:Label>
 </div>
