<%@ Page Title="" Language="C#" AutoEventWireup="true"  EnableEventValidation="false" CodeFile="ReportHeaderSpecsSelfInfor.aspx.cs" Inherits="ASPXReportHeaderSpecsSelfInfor" %>

<%@ Register src="~/Frame/TestReport/ReportHeaderSpecsInfo.ascx" tagname="ReportHeaderSpecsInfo" tagprefix="uc1" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="表头规格项信息"></asp:Label>
 </div>
