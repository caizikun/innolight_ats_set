<%@ Page Title="" Language="C#" AutoEventWireup="true"  EnableEventValidation="false" CodeFile="ModelRelationListAdd.aspx.cs" Inherits="ModelRelationListAdd" %>

<%@ Register src="~/Frame/OptionButtons.ascx" tagname="OptionButtons" tagprefix="uc3" %>
<%@ Register src="~/Frame/APPModel/ModelRelationAddList.ascx" tagname="ModelRelationAddList" tagprefix="uc4" %>
