<%@ Page Title="" Language="C#" AutoEventWireup="true"  EnableEventValidation="false" CodeFile="GlobalModelParamsList.aspx.cs" Inherits="WebFiles_APPModel_GlobalModelParamsList" %>

<%@ Register src="~/Frame/APPModel/GlobalModelList.ascx" tagname="GlobalModelList" tagprefix="uc1" %>
<%@ Register src="~/Frame/APPModel/GlobalModelParamsList.ascx" tagname="GlobalModelParamList" tagprefix="uc2" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="测试模型参数列表"></asp:Label>
 </div>
