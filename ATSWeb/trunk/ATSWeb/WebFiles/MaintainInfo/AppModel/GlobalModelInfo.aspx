<%@ Page Title="" Language="C#" AutoEventWireup="true" EnableEventValidation="false"  CodeFile="GlobalModelInfo.aspx.cs" Inherits="WebFiles_APPModel_GlobalModelInfo" %>

<%@ Register src="~/Frame/APPModel/GlobalModelInfo.ascx" tagname="GlobalModelInfo" tagprefix="uc1" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="测试模型信息"></asp:Label>
 </div>
