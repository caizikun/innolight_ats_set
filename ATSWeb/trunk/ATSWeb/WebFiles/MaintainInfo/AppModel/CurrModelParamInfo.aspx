<%@ Page Title="" Language="C#" AutoEventWireup="true"  EnableEventValidation="false" CodeFile="CurrModelParamInfo.aspx.cs" Inherits="WebFiles_APPModel_CurrModelParamInfo" %>

<%@ Register src="~/Frame/APPModel/GlobalModelParam.ascx" tagname="GlobalModelParam" tagprefix="uc1" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="测试模型参数信息"></asp:Label>
 </div>
