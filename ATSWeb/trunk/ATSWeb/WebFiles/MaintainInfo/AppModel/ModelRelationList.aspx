<%@ Page Title="" Language="C#" AutoEventWireup="true"  EnableEventValidation="false" CodeFile="ModelRelationList.aspx.cs" Inherits="WebFiles_APPModel_ModelRelationList" %>

<%@ Register src="~/Frame/APPModel/ModelRelationList.ascx" tagname="GlobalModelRelationList" tagprefix="uc1" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="模型冲突关系列表"></asp:Label>
 </div>
