<%@ Page Title="" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="ProductionModuleTypeList.aspx.cs" Inherits="ASPXProductionModuleTypeList" %>

<%@ Register src="~/Frame/Production/ProductionModuTypeList.ascx" tagname="ModuleType" tagprefix="uc1" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="产品类型列表"></asp:Label>
 </div>
...
<asp:ScriptManager ID="ScriptManager1" runat="server" AsyncPostBackTimeout="0">
 ...
 <table border="0" cellspacing="0">
    	<tr valign="middle">
            <td id="ModuleTypeContent0">                
             <asp:PlaceHolder ID="pdmodutype" Runat="Server" ></asp:PlaceHolder> 
            </td>
    	</tr>
    </table>  
