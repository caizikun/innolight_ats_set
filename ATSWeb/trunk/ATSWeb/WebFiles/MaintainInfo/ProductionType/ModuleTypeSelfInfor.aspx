<%@ Page Title="" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="ModuleTypeSelfInfor.aspx.cs" Inherits="ASPXModuleTypeSelfInfor" %>

<%@ Register src="~/Frame/OptionButtons.ascx" tagname="OptionButtons" tagprefix="uc1" %>
<%@ Register src="~/Frame/TestPlan/MConfigInitSelfInfor.ascx" tagname="MConfigInitSelfInfor" tagprefix="uc2" %>
<%@ Register src="~/Frame/Production/ModuleTypeSelfInfor.ascx" tagname="ModuleTypeSelfInfor" tagprefix="uc3" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="产品类型信息"></asp:Label>
 </div>
...
<asp:ScriptManager ID="ScriptManager1" runat="server" AsyncPostBackTimeout="0">
  ...
  <table border="0" cellspacing="2" cellpadding="0" width="100%">        
    	<tr>
    		<td>                 
             <asp:PlaceHolder ID="ModuleTypeSelfInfor" Runat="Server" ></asp:PlaceHolder> 
            </td>
    	</tr>   
</table>
</ContentTemplate>
