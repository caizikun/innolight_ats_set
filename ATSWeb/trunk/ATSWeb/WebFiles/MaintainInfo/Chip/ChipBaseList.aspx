<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="ChipBaseList.aspx.cs" Inherits="ASPXChipBaseList" %>

<%@ Register src="~/Frame/OptionButtons.ascx" tagname="OptionButtons" tagprefix="uc1" %>
<%@ Register src="~/Frame/Chip/BaseChipList.ascx" tagname="BaseChipList" tagprefix="uc2" %>
...
<table border="0" cellspacing="0" > 
    	<tr valign="middle">
            <td id="PNContent0" >  
               <asp:PlaceHolder ID="chipBase_List" Runat="Server" ></asp:PlaceHolder> 
            </td>
    	</tr>
    </table> 
