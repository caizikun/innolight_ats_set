<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="ChipSelfInfor.aspx.cs" Inherits="ASPX_Chip_ChipSelfInfor" %>

<%@ Register src="~/Frame/OptionButtons.ascx" tagname="OptionButtons" tagprefix="uc1" %>
<%@ Register src="~/Frame/Chip/ChipSelfInfor.ascx" tagname="ChipSelfInfor" tagprefix="uc2" %>
...
<div id="Main" class="Main">
  ...
  <table border="0" cellspacing="2" cellpadding="0" width="100%">        
    	<tr>
    		<td>
             <asp:PlaceHolder ID="ChipInfor" Runat="Server" ></asp:PlaceHolder> 
            </td>
    	</tr>   
</table>
</ContentTemplate>
