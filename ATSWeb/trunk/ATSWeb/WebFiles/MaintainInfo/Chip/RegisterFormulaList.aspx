<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="RegisterFormulaList.aspx.cs" Inherits="WebFiles_Chip_RegisterFormulaList" %>

<%@ Register src="~/Frame/OptionButtons.ascx" tagname="OptionButtons" tagprefix="uc1" %>
<%@ Register src="~/Frame/Chip/FormulaList.ascx" tagname="FormulaList" tagprefix="uc2" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="芯片寄存器列表"></asp:Label>
 </div>
...
<table border="0" cellspacing="0" > 
    	<tr valign="middle">
            <td>  
               <asp:PlaceHolder ID="RegisterFormular_List" Runat="Server" ></asp:PlaceHolder> 
            </td>
    	</tr>
    </table> 
