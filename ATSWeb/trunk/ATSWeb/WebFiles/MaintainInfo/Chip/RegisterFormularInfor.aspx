<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="RegisterFormularInfor.aspx.cs" Inherits="WebFiles_Chip_RegisterFormularInfor" %>

<%@ Register src="~/Frame/OptionButtons.ascx" tagname="OptionButtons" tagprefix="uc1" %>
<%@ Register src="~/Frame/Chip/FormulaINFor.ascx" tagname="FormulaINFor" tagprefix="uc2" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="寄存器信息"></asp:Label>
 </div>
...
<div id="Main" class="Main">
  ...
  <table border="0" cellspacing="2" cellpadding="0" width="100%">        
    	<tr>
    		<td>
             <asp:PlaceHolder ID="FormulaSelfInfor" Runat="Server" ></asp:PlaceHolder> 
            </td>
    	</tr>   
</table>
</ContentTemplate>
