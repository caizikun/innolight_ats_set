<%@ Page Title="" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="CurrEquipParamInfo.aspx.cs" Inherits="WebFiles_Equipment_CurrEquipParamInfo" %>

<%@ Register src="~/Frame/Equipment/GlobalEquipParam.ascx" tagname="GlobalEquipParam" tagprefix="uc1" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="设备参数信息"></asp:Label>
 </div>
