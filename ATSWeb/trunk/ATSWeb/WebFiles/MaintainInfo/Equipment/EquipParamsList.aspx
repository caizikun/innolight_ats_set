<%@ Page Title="" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="EquipParamsList.aspx.cs" Inherits="WebFiles_Equipment_EquipParamsList" %>

<%@ Register src="~/Frame/Equipment/GlobalEquipList.ascx" tagname="GlobalEquipList" tagprefix="uc1" %>
<%@ Register src="~/Frame/Equipment/GlobalEquipParamList.ascx" tagname="GlobalEquipParamList" tagprefix="uc2" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="设备参数列表"></asp:Label>
 </div>
