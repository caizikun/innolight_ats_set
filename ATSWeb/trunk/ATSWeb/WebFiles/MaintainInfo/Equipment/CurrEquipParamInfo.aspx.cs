...
{
    const string funcItemName = "设备参数信息";
    ...
    public bool SaveData(object obj, string prameter)
    {
        try
        {
            if (mydt.Rows.Count == 1)
            {
                ...
                {
                    mydt.AcceptChanges();
                    Response.Redirect("~/WebFiles/MaintainInfo/Equipment/EquipParamsList.aspx?uId=" + EquipID, false);
                }
                else
                {
                ...
                case "BOOL":
                    {
                        ...
                        inputControl.ConfigRegularExpressionValidatorErrMessage = "请输入0或false、1或true";
                ...
                case "DOUBLE":
                    {
                        ...
                        inputControl.ConfigRegularExpressionValidatorErrMessage = "请输入双精度浮点数，可用科学计数法表示";
                        break;
                    }
                case "int":
                case "INT":
                ...
                case "ARRAYLIST":
                    {
                        ...
                        inputControl.ConfigRegularExpressionValidatorErrMessage = "请输入整数或单精度浮点数，并用逗号隔开";
                        break;
                    }
                default:
                    break;
