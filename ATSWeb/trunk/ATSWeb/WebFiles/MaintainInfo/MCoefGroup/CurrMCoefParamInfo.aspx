<%@ Page Title="" Language="C#" AutoEventWireup="true"  EnableEventValidation="false" CodeFile="CurrMCoefParamInfo.aspx.cs" Inherits="WebFiles_MCoefGroup_CurrMCoefParamInfo" %>

<%@ Register src="~/Frame/MCoefGroup/GlobalMCoefParam.ascx" tagname="GlobalMCoefParam" tagprefix="uc1" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="模块系数参数信息"></asp:Label>
 </div>
