<%@ Page Title="" Language="C#" AutoEventWireup="true" EnableEventValidation="false"  CodeFile="GlobalMCoefInfo.aspx.cs" Inherits="WebFiles_MCoefGroup_GlobalMCoefInfo" %>

<%@ Register src="~/Frame/MCoefGroup/GlobalMCoefInfo.ascx" tagname="GlobalMCoefInfo" tagprefix="uc1" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="模块系数信息"></asp:Label>
 </div>
...
<asp:ScriptManager ID="ScriptManager1" runat="server" AsyncPostBackTimeout="0">
  ...
  <table border="0" cellspacing="2" cellpadding="0" width="100%">        
    	<tr>
    		<td>                 
             <asp:PlaceHolder ID="MCoefSelfInfor" Runat="Server" ></asp:PlaceHolder> 
            </td>
    	</tr>   
</table>
</ContentTemplate>
