<%@ Page Title="" Language="C#" AutoEventWireup="true"  EnableEventValidation="false" CodeFile="GlobalMCoefParamsList.aspx.cs" Inherits="WebFiles_MCoefGroup_GlobalMCoefParamsList" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="模块系数参数列表"></asp:Label>
 </div>
