<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="CopyMCoef.aspx.cs" Inherits="ASPXCopyMCoef" %>

<%@ Register src="~/Frame/MCoefGroup/CopyMCoef.ascx" tagname="CopyMCoef" tagprefix="uc1" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server" AsyncPostBackTimeout="0">
   ...
   <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Always" runat="server">
    	...
    	<tr>
    		<td>            
             <asp:PlaceHolder ID="AddNewMCoef" Runat="Server" ></asp:PlaceHolder> 
            </td>
    	</tr>   
</table>
                 </ContentTemplate>
