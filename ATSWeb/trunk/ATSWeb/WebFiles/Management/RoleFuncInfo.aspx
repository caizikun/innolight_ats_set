<%@ Page Title="" Language="C#" AutoEventWireup="true" EnableEventValidation="false"  CodeFile="RoleFuncInfo.aspx.cs" Inherits="WebFiles_UserRoleFunc_RoleFuncInfo" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="角色权限信息"></asp:Label>
 </div>
