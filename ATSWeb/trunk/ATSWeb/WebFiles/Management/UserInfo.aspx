<%@ Page Title="" Language="C#" AutoEventWireup="true"  EnableEventValidation="false" CodeFile="UserInfo.aspx.cs" Inherits="WebFiles_UserRoleFunc_UserInfo" %>

<%@ Register src="~/Frame/OptionButtons.ascx" tagname="OptionButtons" tagprefix="uc3" %>
<%@ Register src="~/Frame/UserRoleFunc/userInfo.ascx" tagname="userInfo" tagprefix="uc1" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="用户信息"></asp:Label>
 </div>
