<%@ Page Title="" Language="C#" AutoEventWireup="true" EnableEventValidation="false"  CodeFile="UserRoleInfo.aspx.cs" Inherits="WebFiles_UserRoleFunc_UserRoleInfo" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="用户角色信息"></asp:Label>
 </div>
