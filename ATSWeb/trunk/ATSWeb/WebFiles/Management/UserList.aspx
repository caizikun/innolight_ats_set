<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="UserList.aspx.cs"  EnableEventValidation="false" Inherits="WebFiles_UserRoleFunc_UserList" %>

<%@ Register src="~/Frame/OptionButtons.ascx" tagname="OptionButtons" tagprefix="uc3" %>
<%@ Register src="~/Frame/UserRoleFunc/acountList.ascx" tagname="acountList" tagprefix="uc1" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="用户列表"></asp:Label>
 </div>
