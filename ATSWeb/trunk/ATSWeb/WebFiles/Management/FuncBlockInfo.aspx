<%@ Page Title="" Language="C#" AutoEventWireup="true"  EnableEventValidation="false"  CodeFile="FuncBlockInfo.aspx.cs" Inherits="WebFiles_UserRoleFunc_FuncBlockInfo" %>

<%@ Register src="~/Frame/OptionButtons.ascx" tagname="OptionButtons" tagprefix="uc3" %>
<%@ Register src="~/Frame/UserRoleFunc/blockInfo.ascx" tagname="blockInfo" tagprefix="uc1" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="功能块信息"></asp:Label>
 </div>
