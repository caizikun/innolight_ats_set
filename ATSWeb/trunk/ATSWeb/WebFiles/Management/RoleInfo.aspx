<%@ Page Title="" Language="C#" AutoEventWireup="true" EnableEventValidation="false"  CodeFile="RoleInfo.aspx.cs" Inherits="WebFiles_UserRoleFunc_RoleInfo" %>

<%@ Register src="~/Frame/OptionButtons.ascx" tagname="OptionButtons" tagprefix="uc3" %>
<%@ Register src="~/Frame/UserRoleFunc/roleInfo.ascx" tagname="roleInfo" tagprefix="uc1" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="角色信息"></asp:Label>
 </div>
