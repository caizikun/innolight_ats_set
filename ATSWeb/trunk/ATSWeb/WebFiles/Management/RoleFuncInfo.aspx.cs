...
{
    const string funcItemName = "角色权限信息";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["uId"] != null)
        {
            ...
            queryStr = "select * from FunctionTable where id in (select FunctionID from RoleFunctionTable where RoleID=" + currID + ")  and FunctionCode!=0 order by FunctionCode";
    ...
    bool getInfo(string filterStr, bool isEditMode = false)
    {
        ...
        try
        {
            ...
            thr.Cells[0].Attributes.Add("style", "width:400px;font-family:'Times New Roman Negreta', 'Times New Roman';"
          ...
          + "font-weight:700;font-size:16px;text-align:center;color:White;vertical-align:middle;border:solid #CCCCCC 1px;background-image:url('../../Images/TableHeader.png');background-repeat:repeat-x;height:27px;");
            ...
            DataTable rolesListTable = pDataIO.GetDataTable("select * from FunctionTable where FunctionCode!=0 order by FunctionCode", "FunctionTable");
    ...
    public bool CancelUpdata(object obj, string prameter)
    {
        try
        {
            Response.Redirect("~/WebFiles/Management/RoleList.aspx", true);
            return true;
        }
        catch (System.Exception ex)
        {
