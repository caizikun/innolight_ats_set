   ...
   private string moduleTypeID = "";
    ...
    public void bindData()
    {
        ...
        else
        {
            for (byte i = 0; i < PNChipSelfInforList.Length; i++)
            {
                ...
                PNChipSelfInforList[i].ID = "id" + mydt.Rows[0]["ID"].ToString().Trim();
    ...
    public bool EditData(object obj, string prameter)
    {
       try
       {
           ...
           OptionButtons1.ConfigTdAddWidth = "68px";
    ...
    public bool PNAuthority()
    {
        ...
        try
        {
            if (pDataIO.OpenDatabase(true))
            {
                DataTable selectPNid = pDataIO.GetDataTable("select PNID from PNChipMap where ID=" + moduleTypeID, "PNChipMap");
