<%@ Page Title="" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="ChipSetControlSelfInfor.aspx.cs" Inherits="ASPXChipSetControlSelfInfor" %>

<%@ Register src="~/Frame/OptionButtons.ascx" tagname="OptionButtons" tagprefix="uc1" %>
<%@ Register src="~/Frame/Production/ChipsetControlSelfInfor.ascx" tagname="ChipsetControlSelfInfor" tagprefix="uc2" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="芯片控制信息"></asp:Label>
 </div>
...
<asp:ScriptManager ID="ScriptManager1" runat="server" AsyncPostBackTimeout="0">
  ...
  <table border="0" cellspacing="2" cellpadding="0" width="100%">        
    	<tr>
    		<td>
             <asp:PlaceHolder ID="ChipsetControlSelfInfor" Runat="Server" ></asp:PlaceHolder> 
            </td>
    	</tr>   
</table>
</ContentTemplate>
