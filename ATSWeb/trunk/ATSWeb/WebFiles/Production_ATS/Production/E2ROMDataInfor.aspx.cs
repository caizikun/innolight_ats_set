...
{
    string funcItemName = "EEPROMData0信息";
    ...
    public void bindData()
    {
        ...
        for (int i = 0; i < e2romDataList.Length; i++)
        {
            ...
            e2romDataList[i].ID = "ID" + i.ToString().Trim();
            ...
            if (i >= 1)
            {
                ...
                //if (i % 2 != 0)
                //{
                //    e2romDataList[i].TrBackgroundColor = "#F2F2F2";
                //}
                        ...
                        case 1:
                            {
                                ...
                                mydt.Rows[0]["Data1"] = contentText;
                                mydt.Rows[0]["CRCData1"] = alg.CRC8(alg.strToHexByte(contentText));
                                break;
                            }
                        case 2:
                            {
                                ...
                                mydt.Rows[0]["Data2"] = contentText;
                                mydt.Rows[0]["CRCData2"] = alg.CRC8(alg.strToHexByte(contentText));
                                break;
                            }
                        case 3:
                            {
                                ...
                                mydt.Rows[0]["Data3"] = contentText;
                                mydt.Rows[0]["CRCData3"] = alg.CRC8(alg.strToHexByte(contentText));
                                break;
                            }
                    }
