<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="pnChannelMapSelfInfor.aspx.cs" Inherits="WebFiles_Production_pnChannelMapSelfInfor" %>

<%@ Register src="~/Frame/OptionButtons.ascx" tagname="OptionButtons" tagprefix="uc1" %>
<%@ Register src="~/Frame/Production/ChannelMapSelf.ascx" tagname="ChannelMapSelf" tagprefix="uc2" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="通道映射信息"></asp:Label>
 </div>
...
<div id="Main" class="Main">
  ...
  <table border="0" cellspacing="0" cellpadding="0" width="100%">        
    	<tr>
    		<td>
             <asp:PlaceHolder ID="ChnnelMAPSelfInfor" Runat="Server" ></asp:PlaceHolder> 
            </td>
    	</tr>   
</table>
</ContentTemplate>
