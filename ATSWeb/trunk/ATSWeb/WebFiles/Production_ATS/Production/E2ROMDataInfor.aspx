<%@ Page Title="" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="E2ROMDataInfor.aspx.cs" Inherits="ASPXE2ROMDataInfor" %>

<%@ Register src="~/Frame/OptionButtons.ascx" tagname="OptionButtons" tagprefix="uc1" %>
<%@ Register src="~/Frame/Production/E2ROMDataInfor.ascx" tagname="E2ROMDataInfor" tagprefix="uc2" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="EEPROM数据信息"></asp:Label>
 </div>
...
<table border="0" cellspacing="0" > 
    	<tr valign="middle">
            <td>               
               <asp:PlaceHolder ID="E2ROMDataInfor" Runat="Server" ></asp:PlaceHolder> 
            </td>
    	</tr>
    </table> 
    </ContentTemplate>
