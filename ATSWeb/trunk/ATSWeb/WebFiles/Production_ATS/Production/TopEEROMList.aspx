<%@ Page Title="" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="TopEEROMList.aspx.cs" Inherits="ASPXTopEEROMList" %>

<%@ Register src="~/Frame/Production/TopE2ROMList.ascx" tagname="TopE2ROMList" tagprefix="uc1" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="EEPROM列表"></asp:Label>
 </div>
...
<div id="Main" class="Main">
 ...
 <table border="0" cellspacing="0">
    	<tr valign="middle">
            <td id="E2ROMList">                
             <asp:PlaceHolder ID="EEPROMList" Runat="Server" ></asp:PlaceHolder> 
            </td>
    	</tr>
    </table>  
