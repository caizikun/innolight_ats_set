<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="PNChipSelf.aspx.cs" Inherits="WebFiles_Production_PNChipSelf" %>

<%@ Register src="~/Frame/OptionButtons.ascx" tagname="OptionButtons" tagprefix="uc1" %>
<%@ Register src="~/Frame/Production/PNChipSelfInfor.ascx" tagname="PNChipSelfInfor" tagprefix="uc2" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="芯片信息"></asp:Label>
 </div>
...
<div id="Main" class="Main">
  ...
  <table border="0" cellspacing="2" cellpadding="0" width="100%">        
    	<tr>
    		<td>
             <asp:PlaceHolder ID="PNChipSelfInfor" Runat="Server" ></asp:PlaceHolder> 
            </td>
    	</tr>   
</table>
</ContentTemplate>
