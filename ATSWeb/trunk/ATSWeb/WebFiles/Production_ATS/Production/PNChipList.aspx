<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="PNChipList.aspx.cs" Inherits="WebFiles_Production_PNChipList" %>

<%@ Register src="~/Frame/OptionButtons.ascx" tagname="OptionButtons" tagprefix="uc1" %>
<%@ Register src="~/Frame/Production/PNChipList.ascx" tagname="PNChipList" tagprefix="uc2" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="芯片列表"></asp:Label>
 </div>
...
<table border="0" cellspacing="0" > 
    	<tr valign="middle">
            <td id="PNContent0" >  
               <asp:PlaceHolder ID="ChipPNList" Runat="Server" ></asp:PlaceHolder> 
            </td>
    	</tr>
    </table> 
