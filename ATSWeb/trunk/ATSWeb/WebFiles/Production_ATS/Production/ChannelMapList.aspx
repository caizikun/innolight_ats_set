<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="ChannelMapList.aspx.cs" Inherits="WebFiles_Production_ChannelMapList" %>

<%@ Register src="~/Frame/OptionButtons.ascx" tagname="OptionButtons" tagprefix="uc1" %>
<%@ Register src="~/Frame/Production/PNChannelMap.ascx" tagname="PNChannelMap" tagprefix="uc2" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="通道映射列表"></asp:Label>
 </div>
...
<table border="0" cellspacing="0" > 
    	<tr valign="middle">
            <td id="PNContent0" >                  
               <asp:PlaceHolder ID="PNChipMapList" Runat="Server" ></asp:PlaceHolder> 
            </td>
    	</tr>
    </table> 
