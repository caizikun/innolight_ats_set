<%@ Page Title="" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="ChipSetControlList.aspx.cs" Inherits="ASPXChipSetControlList" %>

<%@ Register src="~/Frame/OptionButtons.ascx" tagname="OptionButtons" tagprefix="uc1" %>
<%@ Register src="~/Frame/Production/ChipSetContrl.ascx" tagname="ChipSetContrl" tagprefix="uc2" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="芯片控制列表"></asp:Label>
 </div>
...
<table border="0" cellspacing="0" > 
    	<tr valign="middle">
            <td id="PNContent0" >                  
               <asp:PlaceHolder ID="ChipsetContrlList" Runat="Server" ></asp:PlaceHolder> 
            </td>
    	</tr>
    </table> 
