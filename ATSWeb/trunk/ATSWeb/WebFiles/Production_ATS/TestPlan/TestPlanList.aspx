<%@ Page Title="" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="TestPlanList.aspx.cs" Inherits="ASPXTestPlanList" %>

<%@ Register src="~/Frame/TestPlan/TestPlanList.ascx" tagname="TestplanTypeList" tagprefix="uc1" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="测试方案列表"></asp:Label>
 </div>
...
<table border="0" cellspacing="0" > 
    	<tr valign="middle">
            <td id="TestPlanContent">   
               <asp:PlaceHolder ID="TestPlanList" Runat="Server" ></asp:PlaceHolder>
            </td>
    	</tr>
    </table> 
