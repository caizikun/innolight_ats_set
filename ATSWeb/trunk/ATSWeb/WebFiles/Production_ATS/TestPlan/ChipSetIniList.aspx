<%@ Page Title="" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="ChipSetIniList.aspx.cs" Inherits="ASPXChipSetIniList" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="芯片初始化列表"></asp:Label>
 </div>
...
<table border="0" cellspacing="0" > 
    	<tr valign="middle">
            <td id="PNContent0" >
               <asp:PlaceHolder ID="ChipsetIniList" Runat="Server" ></asp:PlaceHolder> 
            </td>
    	</tr>
    </table> 
