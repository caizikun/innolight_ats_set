<%@ Page Title="" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="TopPNSpecList.aspx.cs" Inherits="ASPXTopPNSpecList" %>

<%@ Register src="~/Frame/OptionButtons.ascx" tagname="OptionButtons" tagprefix="uc1" %>
<%@ Register src="~/Frame/TestPlan/TopPNSpecsList.ascx" tagname="TopPNSpecsList" tagprefix="uc2" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="规格参数列表"></asp:Label>
 </div>
...
<table border="0" cellspacing="0" > 
    	<tr valign="middle">
            <td id="topPNSpecs">                
             <asp:PlaceHolder ID="topPNSpecsList" Runat="Server" ></asp:PlaceHolder> 
            </td>
    	</tr>
    </table>  
