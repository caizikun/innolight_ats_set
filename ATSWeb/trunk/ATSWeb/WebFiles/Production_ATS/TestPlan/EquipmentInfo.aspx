<%@ Page Title="" Language="C#" AutoEventWireup="true"  EnableEventValidation="false"  CodeFile="EquipmentInfo.aspx.cs" Inherits="WebFiles_TestPlan_TopoEquipment" %>

<%@ Register src="~/Frame/TestPlan/TopoEquipInfo.ascx" tagname="TopoEquipInfo" tagprefix="uc1" %>
<%@ Register src="~/Frame/TestPlan/TopoEquipParam.ascx" tagname="TopoEquipParam" tagprefix="uc2" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="设备信息"></asp:Label>
 </div>
...
<div id="Main" class="Main"> 
   ...
   <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Always" runat="server">
      <ContentTemplate>
        <table id="tableParams" runat="server" border="0" cellspacing="0">        
    	    <tr>
    		    <td id="ParamsContent" >            
