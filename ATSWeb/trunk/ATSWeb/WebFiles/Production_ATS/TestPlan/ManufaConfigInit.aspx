<%@ Page Title="" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="ManufaConfigInit.aspx.cs" Inherits="ASPXManufaConfigInit" %>

<%@ Register src="~/Frame/TestPlan/ManufConfigInitList.ascx" tagname="ManufConfigInitList" tagprefix="uc1" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="模块配置列表"></asp:Label>
 </div>
...
<table border="0" cellspacing="0" > 
    	<tr valign="middle">
    		<td>            
             <asp:PlaceHolder ID="MConfigInitList" Runat="Server" ></asp:PlaceHolder> 
            </td>
    	</tr>   
</table>
