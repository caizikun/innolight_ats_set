<%@ Page Title="" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="TopPNSpecSeflInfor.aspx.cs" Inherits="ASPXTopPNSpecSeflInfor" %>

<%@ Register src="~/Frame/TestPlan/PNSpecInfor.ascx" tagname="PNSpecInfor" tagprefix="uc1" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="规格参数信息"></asp:Label>
 </div>
...
<asp:ScriptManager ID="ScriptManager1" runat="server" AsyncPostBackTimeout="0">
  ...
  <table border="0" cellspacing="2" cellpadding="0" width="100%" >       
    	<tr>
    		<td> 
             <asp:PlaceHolder ID="PNSpecSelfInfor" Runat="Server" ></asp:PlaceHolder> 
            </td>
    	</tr>   
</table>
</ContentTemplate>
