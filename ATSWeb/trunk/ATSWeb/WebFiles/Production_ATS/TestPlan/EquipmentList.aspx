<%@ Page Title="" Language="C#" AutoEventWireup="true"  EnableEventValidation="false"  CodeFile="EquipmentList.aspx.cs" Inherits="WebFiles_TestPlan_Terry_EquipmentList" %>

<%@ Register src="~/Frame/TestPlan/TopoEquipList.ascx" tagname="EquipList" tagprefix="uc1" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="设备列表"></asp:Label>
 </div>
...
<div id="Main" class="Main">
   ...
   <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Always" runat="server">
      <ContentTemplate>
        <table id="tableFC" runat="server"  border="0" cellspacing="0">        
    	    <tr valign="middle">
    		    <td id="EqContent" >            
