<%@ Page Title="" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="AddNewFlowControl.aspx.cs" Inherits="ASPXAddNewFlowControl" %>
...
<%--<body onkeydown="if (event.keyCode == 116){window.parent.focus();reloadIframe();return false;}">--%>
