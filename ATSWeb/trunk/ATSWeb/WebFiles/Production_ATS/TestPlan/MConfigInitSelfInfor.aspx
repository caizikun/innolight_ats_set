<%@ Page Title="" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="MConfigInitSelfInfor.aspx.cs" Inherits="ASPXMConfigInitSelfInfor" %>

<%@ Register src="~/Frame/TestPlan/MConfigInitSelfInfor.ascx" tagname="MConfigInitSelfInfor" tagprefix="uc1" %>
...
<div id="Options" class="Options">
 ...
 <div class="OptionLabel" >              
      <asp:Label ID="LabelList" runat="server" Text="模块配置信息"></asp:Label>
 </div>
...
<asp:ScriptManager ID="ScriptManager1" runat="server" AsyncPostBackTimeout="0">
   ...
   <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Always" runat="server">
      <ContentTemplate>
    	...
    	<tr>
    		<td>            
             <asp:PlaceHolder ID="MConfigInitSelfInforPH" Runat="Server" ></asp:PlaceHolder> 
            </td>
    	</tr>
    </table>
