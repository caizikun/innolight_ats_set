<%@ Page Title="" Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="AddNewMConfigInit.aspx.cs" Inherits="ASPXAddNewMConfigInit" %>
...
<div id="Main" class="Main">
   ...
   <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Always" runat="server">
      <ContentTemplate>
    	...
    	<tr>
    		<td>            
             <asp:PlaceHolder ID="AddNewMConfigInit" Runat="Server" ></asp:PlaceHolder> 
            </td>
    	</tr>   
        </table>
      </ContentTemplate>
