<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RegisterList.ascx.cs" Inherits="Frame_Chip_RegisterList" %>
<div  >
...
<tr>
   ...
   <th ID="TH3Title" class="tHStyleLeft" width="136px" runat="server">
       <asp:Label ID="TH3" class="tdLeft" runat="server" Text="Address(Dec)"></asp:Label>
   </th>
    <th ID="TH4Title" class="tHStyleLeft" width="136px" runat="server">
       <asp:Label ID="TH4" class="tdLeft" runat="server" Text="StartBit"></asp:Label>
   </th>
  <th ID="TH2Title" class="tHStyleLeft" width="136px" runat="server">
       <asp:Label ID="TH2" class="tdLeft" runat="server" Text="EndBit"></asp:Label>
   </th>
   <th ID="TH5Title" class="tHStyleLeft" width="136px" runat="server">
       <asp:Label ID="TH5" class="tdLeft" runat="server" Text="UnitLength"></asp:Label>
   </th>
  <th ID="TH6Title" class="tHStyleLeft" width="136px" runat="server">
       <asp:Label ID="TH6" class="tdLeft" runat="server" Text="ChipLine"></asp:Label>
   </th>
</tr>
