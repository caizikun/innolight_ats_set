...
public partial class ASCXReportHeaderSpecsList : System.Web.UI.UserControl
{
    #region ConfigID
    ...
    public string LbShowNameText
    {
        get
        {
            return this.LbShowName.Text;

        }
        set
        {
            this.LbShowName.Text = value;
        }
    }
