...
public partial class Frame_Production_PNChipList : System.Web.UI.UserControl
{
    #region ConfigID
    ...
    public string PostBackUrlStringChannelMap
    {
        get
        {
            return LinkBChannelMapControl.PostBackUrl;
        }
        set
        {
            LinkBChannelMapControl.PostBackUrl = value;
        }
    }
   
  
    public string PostBackUrlStringPNChipSelf
    {
        get
        {
