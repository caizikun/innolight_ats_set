...
public partial class Frame_APPModel_GlobalModelList : System.Web.UI.UserControl
{
    ...
    public bool SetModelEnableState(bool state = false)
    {
        try
        {
            ...
            this.lnkViewRelation.Visible = !state;
            return true;
        }
        catch
        { return false; }
    ...
    public string LnkViewRelationPostBackUrl
    {
        get { return this.lnkViewRelation.PostBackUrl; }
        set { lnkViewRelation.PostBackUrl = value; }
    }

    public string TxtLnkViewRelation
    {
        get { return this.lnkViewRelation.Text; }
        set { lnkViewRelation.Text = value; }
    }

    public string TxtItemWeight
    {
        get { return lbItemWeight.Text; }
        set
        {
            this.lbItemWeight.Text = value;
        }
    }

    public void EnableLnkViewRelation(bool status)
    {
        lnkViewRelation.Enabled = status;
    }
