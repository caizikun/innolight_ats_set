...
#endregion
#region Method
        public TestTempDmi(DUT inPuDut)
        {
        ...
        protected override bool StartTest()
        {
            ...
            {               
                ...
                // open apc
                Log.SaveLogToTxt("Step3...ReadDmiTemp");
                Thread.Sleep(30000);
                tempDmi = dut.ReadDmiTemp();
                tempDmiErr = tempDmi - GlobalParameters.CurrentTemp;
                Log.SaveLogToTxt("tempDmi=" + tempDmi.ToString());
                Log.SaveLogToTxt("tempDmiErr=" + tempDmiErr.ToString());
                OutPutandFlushLog();
                return true;
            }
            else
