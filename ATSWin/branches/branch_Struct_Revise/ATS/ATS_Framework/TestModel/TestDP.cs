...
namespace ATS_Framework
{
    ...
    public class TestTxDP : TestModelBase
    {
        ...
        public override bool Test()
        {
            ...
            try
            {
               ...
               // MyEqupment.pATT.o
                ...
                Log.SaveLogToTxt("ShortFiberCsen=" + MyTestModePrameter.ShortFiberCsen);
                ...
                Log.SaveLogToTxt("LongFiberCsen=" + MyTestModePrameter.LongFiberCsen);
        ...
        private bool NormalTest()
        {
            ...
            Log.SaveLogToTxt("sensitivityPoint= " + MyTestModePrameter.sensitivityPoint.ToString());
        ...
        public override bool SelectEquipment(EquipmentList aEquipList)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        Log.SaveLogToTxt("OptSwitch =NULL");
                    }
                    isOK = false;
                    OutPutandFlushLog();
                    isOK = false;
        ...
        protected bool SerchCoefPoints(double inputPower)// 需要一个输入参数
        {
            ...
            //{
            //    Log.SaveLogToTxt(MyBackGroundLog.Dequeue());
...
;
        ...
        protected double binarySearchTargetPoint()
        {
            ...
            Log.SaveLogToTxt("RxInputPower=" + ((MyInputParameter.SearchTargetBerRxpowerUL + MyInputParameter.SearchTargetBerRxpowerLL) / 2).ToString());
        ...
        protected void QuickTest()
        {
            try
            {
                ...
                Log.SaveLogToTxt("SetAtten=" + MyInputParameter.CsenStartingRxPwr.ToString());
                ...
                {   
                    ...
                    else
                    {
                        ...
                        Log.SaveLogToTxt("AttPoint=" + MyInputParameter.CsenStartingRxPwr.ToString() + MyTestModePrameter.ber_erp.ToString());
        ...
        protected bool SerchTargetBer()
        {
            try
            {
                ...
                Log.SaveLogToTxt("FirstBerPointRxPower=" + MyTestModePrameter.FirstBerPointRxPower.ToString());
                for (byte i = 0; i < MyProcessData.serchAttPoints.Count; i++)
                {
                    Log.SaveLogToTxt("serchAttPoints[ " + i.ToString() + "]" + MyProcessData.serchAttPoints[i].ToString() + "  " + "serchRxDmidPoints[ " + i.ToString() + "]"  + "serchBerPoints[ " + i.ToString() + "]" + MyProcessData.serchBerPoints[i].ToString());
                }
