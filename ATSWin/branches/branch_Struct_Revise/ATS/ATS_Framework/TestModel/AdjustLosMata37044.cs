...
namespace ATS_Framework
{
    ...
    public class AdjustLosMata37044 : TestModelBase
    {
        ...
        #endregion
        #region Method
        public AdjustLosMata37044(DUT inPuDut)
        {
        ...
        protected bool WriteFixedLosValue(DUT dut)
        {
            ...
            Thread.Sleep(100);
            targetLosADac =Convert.ToUInt16( adjustLosStruct.LosAVoltageStartValue);
            targetLosDDac = Convert.ToUInt16(adjustLosStruct.LosDVoltageStartValue);
