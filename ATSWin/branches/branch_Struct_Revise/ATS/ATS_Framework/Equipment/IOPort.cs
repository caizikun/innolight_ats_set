...
namespace ATS_Framework
{
    ...
    { 
        ...
        public static void CFPCtrlNorPinBase(int deviceIndex, byte cmd, byte rw, byte DDR, byte setData, out byte getData)
        {
            OpenDevice(deviceIndex);
        ...
        private string WriteReadString_GPIB(string ioaddr, string str_Write, ReadWrite operation, int count = 0)
        {
            ...
            catch (Exception ex)
            {
                ...
                Log.SaveLogToTxt("ErrorCode=" + ExceptionDictionary.Code._Funtion_Fatal_0x05002 + "Reason=" + ex.TargetSite.Name + "Fail");
                throw new InnoExCeption(ExceptionDictionary.Code._Funtion_Fatal_0x05002, ex.StackTrace);
                //return buf;
            }
        }
