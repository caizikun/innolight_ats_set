    ...
    public class EEPROM
    {
        ...
        public static void settempaw(int deviceIndex, int deviceAddress, int regAddress, decimal tempaw)
        {
            ...
            try
            {
                ...
                IOPort.WriteReg(deviceIndex, deviceAddress, regAddress, IOPort.SoftHard.HARDWARE_SEQUENT, buff);
        ...
        public static bool floattoieee(int deviceIndex, int deviceAddress, int regAddress, float fcoef, int phycialAdress = 0, int mdiomode = 0)
        {
            ...
            {
                IOPort.WriteReg(deviceIndex, deviceAddress, regAddress, IOPort.SoftHard.HARDWARE_SEQUENT, bcoef);
                System.Threading.Thread.Sleep(200);
        ...
        public static byte[] ReadWriteDriverQSFP(int deviceIndex, int deviceAddress, int StartAddress, int regAddress, byte channel, byte operation, byte chipset, byte[] buffer,bool Switch)
        {
            ...
            IOPort.WriteReg(deviceIndex, deviceAddress, StartAddress+1, IOPort.SoftHard.HARDWARE_SEQUENT, tempData);
            
            System.Threading. Thread.Sleep(50);

            IOPort.WriteReg(deviceIndex, deviceAddress, StartAddress, IOPort.SoftHard.HARDWARE_SEQUENT, tempData1);
            for (int i = 0; i < 10; i++)
            {
                System.Threading.Thread.Sleep(50);
        ...
        public static byte[] ReadWriteDriverSFP(int deviceIndex, int deviceAddress, int StartAddress, int regAddress, byte operation, byte chipset, byte[] buffer)
        {
            ...
            try
            {
                for (int i = 0; i < buffer.Length / RegistWide; i++)
                {
                    ...
                    tempData1[0] = chipoperation;
                    IOPort.WriteReg(deviceIndex, deviceAddress, StartAddress, IOPort.SoftHard.HARDWARE_SEQUENT, tempData);
                    IOPort.WriteReg(deviceIndex, deviceAddress, StartAddress + 8, IOPort.SoftHard.HARDWARE_SEQUENT, tempData1);
                    for (int j = 0; j < 10; j++)
                    {
                        System.Threading.Thread.Sleep(50);
        ...
        public static byte[] ReadWriteDriverSFP28(int deviceIndex, int deviceAddress, int StartAddress, int regAddress, byte operation, byte chipset, byte[] buffer)
        {
            //database 0: LDD 1: AMP 2: DAC 3: CDR
