...
{   
    public class SqlManager : ServerDatabaseIO  //140722_2  
    {
        ...
        public override bool UpdateDT()
        {
            ...
            long myNewlastIDGlobalEEPROMInit = GetLastInsertData("TopoMSAEEPROMSet");      //140706_0
            ...
            long myNewlastIDSpecs = GetLastInsertData("GlobalSpecs");           //150430_0
            long myNewlastIDPNSpecPrmtr = GetLastInsertData("TopoPNSpecsParams");           //150430_0
            ...
            try
            {
                ...
                SqlCommand cm9 = new SqlCommand("select * from  " + "TopoMSAEEPROMSet", conn);
                ...
                //150430_0 -------------------
                SqlCommand cm15 = new SqlCommand("select * from  " + "GlobalSpecs", conn);
                SqlDataAdapter da15 = new SqlDataAdapter(cm15);
                SqlCommandBuilder cb15 = new SqlCommandBuilder(da15);
                DataTable dt15= new DataTable();
                da15.SelectCommand.Transaction = tr;
                da15.Fill(dt15);

                SqlCommand cm16 = new SqlCommand("select * from  " + "TopoPNSpecsParams", conn);
                SqlDataAdapter da16 = new SqlDataAdapter(cm16);
                SqlCommandBuilder cb16 = new SqlCommandBuilder(da16);
                DataTable dt16 = new DataTable();
                da16.SelectCommand.Transaction = tr;
                da16.Fill(dt16);
                ...
                for (int i = 0; i < MainForm.GlobalDS.Tables["TopoMSAEEPROMSet"].Rows.Count; i++)
                {
                    if ((MainForm.GlobalDS.Tables["TopoMSAEEPROMSet"].Rows[i].RowState == DataRowState.Added)
                        && (Convert.ToInt64(MainForm.GlobalDS.Tables["TopoMSAEEPROMSet"].Rows[i]["ID"]) > MainForm.origIDEEPROMInit)
                       )
                    {
                        MainForm.GlobalDS.Tables["TopoMSAEEPROMSet"].Rows[i]["ID"] = myNewlastIDGlobalEEPROMInit + 1;
                ...
                for (int i = 0; i < MainForm.GlobalDS.Tables["GlobalProductionName"].Rows.Count; i++)
                {
                    if ((MainForm.GlobalDS.Tables["GlobalProductionName"].Rows[i].RowState == DataRowState.Added)
                        && (Convert.ToInt64(MainForm.GlobalDS.Tables["GlobalProductionName"].Rows[i]["ID"]) > MainForm.origIDGlobalPN))
                    {
                ...
                //150430_0 -----------------
                for (int i = 0; i < MainForm.GlobalDS.Tables["GlobalSpecs"].Rows.Count; i++)
                {
                    if ((MainForm.GlobalDS.Tables["GlobalSpecs"].Rows[i].RowState == DataRowState.Added)
                        && (Convert.ToInt64(MainForm.GlobalDS.Tables["GlobalSpecs"].Rows[i]["ID"]) > MainForm.origIDMCoefPrmtr)
                       )
                    {
                        MainForm.GlobalDS.Tables["GlobalSpecs"].Rows[i]["ID"] = myNewlastIDSpecs + 1;
                        myNewlastIDSpecs++;
                    }
                }
                ...
                {
                    if ((MainForm.GlobalDS.Tables["TopoPNSpecsParams"].Rows[i].RowState == DataRowState.Added)
                        && (Convert.ToInt64(MainForm.GlobalDS.Tables["TopoPNSpecsParams"].Rows[i]["ID"]) > MainForm.origIDMCoefPrmtr)
                       )
                    {
                        MainForm.GlobalDS.Tables["TopoPNSpecsParams"].Rows[i]["ID"] = myNewlastIDPNSpecPrmtr + 1;
                        myNewlastIDPNSpecPrmtr++;
                    }
                }
                #endregion

                dt15 = MainForm.GlobalDS.Tables["GlobalSpecs"];
                dt16 = MainForm.GlobalDS.Tables["TopoPNSpecsParams"];
                ...
                dt9 = MainForm.GlobalDS.Tables["TopoMSAEEPROMSet"];
                ...
                DataTable dtAdded15 = new DataTable(); //存放GlobalSpec主表 新增 的数据
                DataTable dtMidified15 = new DataTable(); //存储主表 编辑 的行记录
                DataTable dtDeleted15 = new DataTable(); //存储主表 删除 的行记录

                dtDeleted15 = dt15.GetChanges(DataRowState.Deleted);
                dtMidified15 = dt15.GetChanges(DataRowState.Modified);
                dtAdded15 = dt15.GetChanges(DataRowState.Added);

                DataTable dtAdded16 = new DataTable(); //存放子表 新增 的数据
                DataTable dtMidified16 = new DataTable(); //存放子表 编辑 的行记录
                DataTable dtDeleted16 = new DataTable(); //存放子表 删除 的行记录

                dtDeleted16 = dt16.GetChanges(DataRowState.Deleted);
                dtMidified16 = dt16.GetChanges(DataRowState.Modified);
                dtAdded16 = dt16.GetChanges(DataRowState.Added);
                //===============================================================
                //删除资料开始
                ...
                //Specs+PNSpecsParams
                if (dtDeleted16 != null) da16.Update(dtDeleted16);
                if (dtDeleted15 != null) da15.Update(dtDeleted15);
                ...
                if (dtAdded15 != null) da15.Update(dtAdded15);
                if (dtMidified15 != null) da15.Update(dtMidified15);

                if (dtAdded16 != null) da16.Update(dtAdded16);
                if (dtMidified16 != null) da16.Update(dtMidified16);
                //新增资料结束
                //===============================================================
    ...
    public class AccessManager : LocalDatabaseIO //140722_2     
    {
        ...
        public override bool UpdateDT()
        {
            ...
            try
            {
                ...
                OleDbCommand cm9 = new OleDbCommand("select * from  " + "TopoMSAEEPROMSet", conn);
                ...
                da14.Fill(dt14);
                //150430_0 -------------------
                OleDbCommand cm15 = new OleDbCommand("select * from  " + "GlobalSpecs", conn);
                OleDbDataAdapter da15 = new OleDbDataAdapter(cm15);
                OleDbCommandBuilder cb15 = new OleDbCommandBuilder(da15);
                DataTable dt15 = new DataTable();
                da15.SelectCommand.Transaction = tr;
                da15.Fill(dt15);

                OleDbCommand cm16 = new OleDbCommand("select * from  " + "TopoPNSpecsParams", conn);
                OleDbDataAdapter da16 = new OleDbDataAdapter(cm16);
                OleDbCommandBuilder cb16 = new OleDbCommandBuilder(da16);
                DataTable dt16 = new DataTable();
                da16.SelectCommand.Transaction = tr;
                da16.Fill(dt16);
