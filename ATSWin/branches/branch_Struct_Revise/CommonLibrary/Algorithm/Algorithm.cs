...
namespace ATS_Framework
{
    ...
    public class Algorithm
    {
        ...
        public static float SelectMinValue(ArrayList inPutArray, out byte minIndex)// for cense test only
        {
            byte itemCount = 0;
            minIndex = 0;
        ...
        public static byte[] Uint16DataConvertoBytes(UInt16 inputdata)
        {
        ...
        public static bool MonotonicIncreasingfun(double[] a, int n)
        {
            if (n == 1)
                return true;
            if (n == 2)
        ...
        public static bool MonotonicDecreasingfun(double[] a, int n)
        {
            if (n == 1)
                return true;
            if (n == 2)
        ...
        /// <returns></returns>
        public static bool FindFileName(TestModeEquipmentParameters[] inputStructArray, string filename, out int index)
        {
        ...
        public static bool FindFileName(DriverStruct[] inputStructArray, string filename, out int index)
        {
            for (byte i = 0; i < inputStructArray.Length; i++)
            {
        ...
        public static bool FindFileName(DutStruct[] inputStructArray, string filename, out int index)
        {
            for (byte i = 0; i < inputStructArray.Length; i++)
            {
                if (inputStructArray[i].FiledName.ToUpper() == filename.ToUpper())
        ...
        /// <returns></returns>
        public static string ArrayListToStringArraySegregateByPunctuations(ArrayList inputArraylist, string segregatestring)
        {
        ...
        public static byte[] FloatToIEE754(object inputfloat)
        {
            try
            {
        ...
        public static byte[] INT16To2Bytes(object inputint16)
        {
        ...
        /// <returns></returns>
        public static string ByteArraytoString(byte scale, string ssegregatestring, byte[] inputarry)
        {
            if (inputarry == null)
            {
                return null;
        ...
        public static string ByteArraytoString(byte scale, string ssegregatestring, UInt16[] inputarry)
        {
            if (inputarry == null)
            {
                return null;
        ...
        public static string ByteArraytoString(byte scale, string ssegregatestring, UInt32[] inputarry)
        {
            if (inputarry == null)
            {
                return null;
        ...
        public static byte[] ObjectTOByteArray(object inputData, byte length, bool LittleEndian)
        {
            ArrayList tempArrlist = new ArrayList();
        ...
        public static bool IBiasMAtoIBiasDAC(string PN, float iBiasMA, UInt32 IModDAC, out UInt32 IBiasDAC)
        {
            PN = PN.ToUpper().Trim();
            switch (PN)
            {
        ...
        public static ArrayList Parse(string expression)
        {
            char ch, ch1;
        ...
        //对两个值利用运算符计算结果
        public static double GetValue(string op, double ch1, double ch2)
        {
            switch (op)
            {
                case "+":
        ...
        //判断堆栈是否为空
        public static bool IsEmpty(Stack st)
        {
            return st.Count == 0 ? true : false;
        }
        public static bool searchRealValue(double ibaisorimod, UInt32 ibiasdac, UInt32 imoddac, string serchStr, out string expression)
        {
            string outStr = "";
            expression = serchStr;
        ...
        public static bool IsOperandStr(string ch)
        {
            string[] operators = { "+", "-", "*", "/", "(", ")" };
            for (int i = 0; i < operators.Length; i++)
                if (ch == operators[i])
        ...
        public static double Calculate(ArrayList bArray, double ibais, UInt32 ibiasdac, UInt32 imoddac)
        {
            double no1, no2, ret;
            Stack myStack = new Stack();
            myStack.Clear();
        ...
        public static double AnalyticalExpression(string expression, double ibaisorimod, UInt32 ibiasdac = 0, UInt32 imoddac = 0)
        {
        ...
        public static double ISNaNorIfinity(double input)
        {
        ...
        public static bool FindDataInDataTable(DataTable inputDT, string filterExpression, out DataRow[] drData)
        {
            try
            {
        ...
        public static SpecTableStruct[] FindDataInDataTable(DataTable inputDT, SpecTableStruct[] inputSList, string currentChannel)
        {
            string selectStr1 = "";
            string selectStr2 = "";
            DataRow[] drData;
        ...
        public static bool GetSpec(DataTable dtSpec, string FiledName, byte CurrentChannel, out Double Max, out double Min)
        {
            Max = 32768;
            Min = -32767;
            byte Channel;
        ...
        public static bool GetSpec(DataTable dtSpec, string FiledName, byte CurrentChannel, out Double Max, out Double TypcalValue, out double Min)
        {
            Max = 32768;
            Min = -32767;
            TypcalValue = -32767;
        ...
        public static bool GetDataTable(DataTable inputDT, string filterExpression, out DataTable dt)
        {
            try
            {
        ...
        /// <returns></returns>
        public static Double[] SortingArray(Double[] ListData)
        {
        ...
        /// <returns></returns>
        public static Double CalculateRxResponsivity(Double RxInputPower, Double RxPowerAdc, double URef, double Rrssi, double Resolution, double Ratio)
        {
        ...
        /// <returns></returns>
        public static int WriteJointBitValue(int WriteData, int ReadData, int length, int StartBit, int EndBit, int MucType = 1)
        {
        ...
        /// <param name="MucType">Mcu类型,1:8bit,2:16bit</param>
        /// <returns></returns>
        public static int ReadJointBitValue(int ReadData, int length, int StartBit, int EndBit, int MucType = 1)
        {
        ...
        /// <param name="Ratio">电压放大比例</param>
        /// <returns></returns>
        public static bool Getconf(TestModeEquipmentParameters[] InputList, string Strfield, bool flagNum, out string goal)
        {
            goal = null;
            int index;
