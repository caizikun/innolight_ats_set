...
namespace ATS_Framework
{
    public class DUT:EquipmentBase
    {
        ...
        public virtual byte[] ReadReg(int deviceAddress, int regAddress, int readLength) { return new byte[16]; }
        public virtual byte[] WrtieReg( int deviceAddress, int regAddress, byte[] dataToWrite) { return new byte[16]; }
        ...
        public virtual bool APCON() { return false; }
        public virtual bool APCOFF() { return false; }
        public virtual bool APCStatus(out string flag) { flag = ""; return false; }

        //edvt

        ////public virtual void SetSoftTxDis(byte channel) { }
        ////public virtual void SetSoftTxEnable(byte channel) { }
        //public virtual void SetSoftTxEnable() { }
        //public virtual bool ReadLatch() { return false; }
        //public virtual void MaskTxpOn() {}
        //public virtual void MaskTxpOff() { }
        //public virtual bool PowerSet(bool onoff) { return false; }
        //public virtual bool PowerOverride(bool onoff) { return false; }
        //public virtual void SetSoftRxDis() { }
        //public virtual void SetSoftRxEnable() { }
        //public virtual void SetRxSquelchDis() { }
        //public virtual void SetRxSquelchEnable() { }
        //public virtual void SetTxSquelchDis() { }
        //public virtual void SetTxSquelchEnable() { }

        //virtual public byte[] FpgaIIC(int deviceIndex, int regAddress, byte operate, byte[] buffer) { return new byte[16]; }
        virtual public byte[] FpgaIICRead(int regAddress, int readLength) { return new byte[16]; }
        virtual public byte[] FpgaIICWrtie(int regAddress, byte[] dataToWrite) { return new byte[16]; }
        virtual public bool FpgaInrush(byte operate) { return true; }
        virtual public bool FpgaLPMode(byte operate) { return true; }
       // virtual public byte[] FpgaMdio(int deviceIndex, int regAddress, byte operate, byte[] buffer) { return new byte[16]; }
        virtual public byte[] MDIORead( int regAddress, int readLength) { return new byte[16]; }
        virtual public byte[] MDIOWrtie(int regAddress, byte[] dataToWrite) { return new byte[16]; }
        virtual public bool FpgaNorsineTxRx(byte operate, int acamplitude, double acfreq, double dcamplitude) { return true; }
        virtual public bool FpgaReset( byte operate) { return true; }
        virtual public bool FpgaResetTimeSet(double delaytime) { return true; }
        virtual public bool FpgaTxDisable(byte operate) { return true; }
        virtual public bool McuFpgaModeSel(byte operate, byte ICSelect) { return true; }
        virtual public bool SamplePowerCurrent(out double current, out double volt) { current = 0; volt = 0; return true; }
        virtual public bool LoadSwitch( byte operate, int acamplitude, double acfreq, double dcamplitude) { return true; }
        // virtual public bool singlePrecisionto4byte(bool Switch) { return true; }

        virtual public bool FpgaSwitch(byte operate) { return true; }
    }
}
