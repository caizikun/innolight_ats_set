...
namespace ATSDataBase
{
    public class DataIO:IDisposable //基类 虚方法!
    {
        ...
        public virtual bool WriterLog(int ConditionID, int SNID, string StrInf, string StartTime, string EndTime, byte Channel, bool Resultlflag, out  int logid) { logid = -1; return true; }
        ...
        public virtual bool WriterSN(int TestPlanID, string StrSN, out int snid) { snid = -1; return true; }
