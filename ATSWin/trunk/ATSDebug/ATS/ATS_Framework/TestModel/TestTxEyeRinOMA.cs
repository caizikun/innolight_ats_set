    ...
    public class TestTxEyeRinOMA : TestModelBase
    {
       ...
       // Algorithm algorithm = new Algorithm();
        ...
        public TestTxEyeRinOMA(DUT inPuDut, logManager logmanager)
        {
           ...
           inPutParametersNameArray.Add("PRBS");
        ...
        public override bool Test()
        {
            ...
            fitDataTable("TxRinOMA(dbm)", TxRinOMA.ToString());
        ...
        {
            if (!pPPG.ConfigurePRBS(pTestTxEyeRinOMAStruct.PRBS)) return false;

            if (!SetTargetPower(pTestTxEyeRinOMAStruct.RinTargetPower)) return false;
        ...
        private bool SetTargetPower(double TargerPower)
        {
            ...
            while (Math.Abs(TargerPower-TempValue)>0.5)
            {
                ...
                else if (TempValue - TargerPower > 0.5)
                {
                    AttStep = 0.5;
                }
                else if (TempValue - TargerPower < -0.5)
        ...
        protected override bool AnalysisInputParameters(TestModeEquipmentParameters[] InformationList)
        {
            ...
            else
            {
                ...
                {
                    if (algorithm.FindFileName(InformationList, "PRBS", out index))
                    {
