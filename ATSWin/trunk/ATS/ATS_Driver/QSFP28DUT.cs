...
namespace ATS_Driver
{
    public class QSFP28DUT:DUT
    {
        ...
        {
            byte[] Readbuff = USBIO.ReadReg(deviceIndex, 0xA0, 86, IOPort.SoftHard.HARDWARE_SEQUENT, 1);
            ...
            try
            {
                ...
                for (int i = 0; i < 3; i++)
                {
                    USBIO.WrtieReg(0, 0xA0, 86, IOPort.SoftHard.HARDWARE_SEQUENT, WriterBuff);
                    Thread.Sleep(100);
                    Readbuff = USBIO.ReadReg(deviceIndex, 0xA0, 86, IOPort.SoftHard.HARDWARE_SEQUENT, 1);
        ...
        public override bool ReadAPDTempAdc(out int APDTempAdc)
        {
            ...
            if (FindFiledNameChannel(out i, "APDTempADC"))
            {
                ...
                try
                {
                    ushort  TempValue = QSFP.readadc(deviceIndex, 0xA0, DutStruct[i].StartAddress);
                    ...
                    logger.AdapterLogString(1, "Current APDTempAdc is" + APDTempAdc);
                    return true;
                }
                catch (Exception error)
                {
            ...
            {
                logger.AdapterLogString(4, "there is no APDTempAdc");
                return true;
            }
        }
        ...
        public override bool ReadTECADC(out ushort Tecadc)
        {
            ...
            if (FindFiledNameChannel(out i, "TECCURRENTADC"))
            {
                ...
                try
                {
                    Tecadc = QSFP.readadc(deviceIndex, 0xA0, DutStruct[i].StartAddress);
                    logger.AdapterLogString(1, "Current Tecadc is" + Tecadc);
                    return true;
            ...
            {
                logger.AdapterLogString(4, "there is no Tecadc");
                return true;
            }
        }
        #endregion
        ...
        public override bool SetAPDdaccoefa(string apddaccoefa)
        {
            ...
            if (FindFiledNameChannel(out i, "DmiAPDCoefA"))
            {
                ...
                try
                {
                    flag = QSFP.SetCoef(deviceIndex, 0xA0, DutStruct[i].StartAddress, apddaccoefa, DutStruct[i].Format);
        ...
        public override bool SetAPDdaccoefb(string apddaccoefb)
        {
            ...
            if (FindFiledNameChannel(out i, "DmiAPDCoefB"))
            {
                ...
                try
                {
                    flag = QSFP.SetCoef(deviceIndex, 0xA0, DutStruct[i].StartAddress, apddaccoefb, DutStruct[i].Format);
                    logger.AdapterLogString(1, "SET DmiAPDCoefB To" + apddaccoefb);
                    return flag;
                }
                catch (Exception error)
                {
            ...
            {
                logger.AdapterLogString(4, "there is no DmiAPDCoefB");
                return true;
            }
        }
        ...
        public override bool SetAPDdaccoefc(string apddaccoefc)
        {
            ...
            if (FindFiledNameChannel(out i, "DmiAPDCoefC"))
            {
                ...
                try
                {
                    flag = QSFP.SetCoef(deviceIndex, 0xA0, DutStruct[i].StartAddress, apddaccoefc, DutStruct[i].Format);
        ...
        public override float GetTxpProportionLessCoef()
        {
            int i = 0;
            bool flag = false;
            if (FindFiledNameChannel(out i, "TXPPROPORTIONLESSCOEF"))
            {
                ...
                try
                {
                 string Str = QSFP.ReadCoef(deviceIndex, 0xA0, DutStruct[i].StartAddress,  DutStruct[i].Format);
                 logger.AdapterLogString(1, "Read TXPPROPORTIONLESSCOEF" + Str);
        ...
        public override float GetTxpProportionGreatCoef()
        {
            ...
            if (FindFiledNameChannel(out i, "TXPPROPORTIONGREATCOEF"))
            {
                ...
                try
                {
                    ...
                    logger.AdapterLogString(1, "Read TXPPROPORTIONGREATCOEF" + Str);
                    return Convert.ToSingle(Str);
        ...
        public override bool TxAllChannelEnable()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                USBIO.WrtieReg(deviceIndex, 0XA0, 86, IOPort.SoftHard.HARDWARE_SEQUENT, dataToWrite);
                dataReadArray = USBIO.ReadReg(deviceIndex, 0XA0, 86, IOPort.SoftHard.HARDWARE_SEQUENT, 1);
        ...
        public override bool GetRegistValueLimmit(byte ItemType, out int Max)
        {
            ...
            switch (ItemType)
            {
                case 0:
                    ...
                    {
                        i = 1;
                        logger.AdapterLogString(3, "GetIbiasRegistLength Error");
                    }
                    break;
                case 1:
                    ...
                    {
                        i = 1;
                        logger.AdapterLogString(3, "GetIModRegistLength Error");
                    }
                    break;
                default:
                    break;
...
#region  AdjustEml
        ...
        {// <param name="ControlType">  1=Write 2=store </param>
            ...
            if (FindFiledNameChannelDAC(out i, "EADAC"))
            {
                ...
                {
                    StoreDriver40g(deviceIndex, 0xA0, startaddr, DriverStruct[i].RegisterAddress, DriverStruct[i].ChipLine, chipset, WriteBiasDacByteArray, ChipsetControll);
                }
                    return true;
            }
            else
            {
                logger.AdapterLogString(4, "there is no EADAC");
                return true;
            }
        }
        ...
        {// <param name="ControlType">  1=Write 2=store </param>
            ...
            {
                logger.AdapterLogString(4, "there is no VCDAC");
                return true;
            }
        }
        ...
        {// <param name="ControlType">  1=Write 2=store </param>
            ...
            {
                logger.AdapterLogString(4, "there is no VLDDAC");
                return true;
            }
        }
        ...
        {// <param name="ControlType">  1=Write 2=store </param>
            ...
            {
                logger.AdapterLogString(4, "there is no VGDAC");
                return true;
            }
        }
        ...
        private bool WriteDac(string StrItem, object DAC)
        {
            ...
            {
                logger.AdapterLogString(3, "Writer " + StrItem + " Error"+EX.Message);
                return false;
            }
        }
            ...
            try
            {
                ...
                if (FindFiledNameChannelDAC(out i, StrItem))
                {
                    ...
                    if (operate == 0)//写
                    {
                        ...
                        //WriteDriver40g(deviceIndex, 0xA2, startaddr, DriverStruct[i].RegisterAddress, chipset, WriteModDacByteArray);
                        WriteDriver40g(deviceIndex, 0xA0, startaddr, DriverStruct[i].RegisterAddress, DriverStruct[i].ChipLine, chipset, WriteDacByteArray, ChipsetControll);
                        //  
                    }
                    else//存
                    {

                       StoreDriver40g(deviceIndex, 0xA0, startaddr, DriverStruct[i].RegisterAddress, DriverStruct[i].ChipLine, chipset, WriteDacByteArray, ChipsetControll);
           ...
           // BiasDac = new byte[length];
            ...
            try
            {
                ...
                if (FindFiledNameChannelDAC(out i, StrItem))
                {
                    ...
                    byte[] TempDacArray = ReadDriver40g(deviceIndex, 0xA0, startaddr, DriverStruct[i].RegisterAddress, DriverStruct[i].ChipLine, chipset, DriverStruct[i].Length, ChipsetControll);
...
#region  AdjustTxAdc
            ...
            if (FindFiledNameChannel(out i, "TxAdcBacklightOffset"))
            {
                ...
                try
                {
                    ...
                    if (double.IsNaN((double)offset))
                    {
                        ...
                        this.WriteReg(deviceIndex, 0xA0, DutStruct[i].StartAddress, writeData);
                        byte[] readData = this.ReadReg(deviceIndex, 0xA0, DutStruct[i].StartAddress, 2);
                        ...
                        logger.AdapterLogString(1, "SET TxAdcBacklightOffset To 0xFF");
                        flag = true;                                              
                    }
                    else
                    {
                        flag = QSFP.SetCoef(deviceIndex, 0xA0, DutStruct[i].StartAddress, offset.ToString(), DutStruct[i].Format);
                        logger.AdapterLogString(1, "SET TxAdcBacklightOffset To" + offset);
                    }
                    return flag;
                }
                catch (Exception error)
        ...
        { // 
            if (matrix == null)
            {
                logger.AdapterLogString(4, "there is no coeff.");
                return false;
            }
                        ...
                        for (int ColumsNo = 0; ColumsNo < matrix.GetLength(1); ColumsNo++)
                        {
                            ...
                            for (int j = 0; j < 3; j++)
                            {
                                ...
                                if (double.IsNaN(matrix[RowNo, ColumsNo]))
                                {
                                    ...
                                    this.WriteReg(deviceIndex, 0xA0, WriterAddress, writeData);
                                    byte[] readData = this.ReadReg(deviceIndex, 0xA0, WriterAddress, 4);
                                ...
                                if (QSFP.SetCoef(deviceIndex, 0xA0, WriterAddress, WriterData, DutStruct[i].Format))
                                {
                                    break;
                                }
                                ...
                                if (j == 2)
                                {
                                    logger.AdapterLogString(3, "TxAdcCalibrateMatrix Row[" + RowNo + "][" + ColumsNo + "]" + "WriterAddress=" + WriterAddress + "WriterData=" + WriterData + " Error");
                                    return false;
                                }
                            }                               
                        }
