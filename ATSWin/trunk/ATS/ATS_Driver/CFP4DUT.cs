    ...
    public class CFP4DUT : DUT
    {
        ...
        public override bool Connect()
        {
            ...
            try
            {
                ...
                EquipmentConnectflag = USBIO.IOConnect() && EVBInitialize();  //add EVB initialize for HW txdis&rxlos
        ...
        public override bool SetRxpcoefa(string rxcoefa)
        {
            ...
            if (FindFiledNameChannel(out i, "DMIRXPOWERCOEFA"))
            {
                ...
                try
                {
                    flag = CFP.SetCoef(deviceIndex, 1, DutStruct[i].StartAddress, sRxCoefaToWrite, DutStruct[i].Format, phycialAdress, 1);
        ...
        public override bool SetRxAdCorSlopcoefb(string rxadcorslopcoefb)
        {
            ...
            if (FindFiledNameChannel(out i, "RXADCORSLOPCOEFB"))
            {
                ...
                try
                {
                    flag = CFP.SetCoef(deviceIndex, 1, DutStruct[i].StartAddress, sRxADCSlopCoefBToWrite, DutStruct[i].Format, phycialAdress, 1);
                    logger.AdapterLogString(0, "SET RXADCORSLOPCOEFB To" + rxadcorslopcoefb);
                    return flag;
                }
        ...
        public override bool SetRxAdCorSlopcoefc(string rxadcorslopcoefc)
        {
            ...
            if (FindFiledNameChannel(out i, "RXADCORSLOPCOEFC"))
            {
                ...
                try
                {
                    flag = CFP.SetCoef(deviceIndex, 1, DutStruct[i].StartAddress, rxadcorslopcoefc, DutStruct[i].Format, phycialAdress, 1);
                    logger.AdapterLogString(0, "SET RXADCORSLOPCOEFC To" + rxadcorslopcoefc);
                    return flag;
                }
                catch (Exception error)
                {
        ...
        public override bool SetRxAdCorOffscoefb(string rxadcoroffsetcoefb)
        {
            ...
            if (FindFiledNameChannel(out i, "RXADCOROFFSCOEFB"))
            {
                ...
                try
                {
                    flag = CFP.SetCoef(deviceIndex, 1, DutStruct[i].StartAddress, rxadcoroffsetcoefb, DutStruct[i].Format, phycialAdress, 1);
                    logger.AdapterLogString(0, "SET RXADCOROFFSCOEFB To" + rxadcoroffsetcoefb);
                    return flag;
                }
                catch (Exception error)
                {
        ...
        public override bool SetRxAdCorOffscoefc(string rxadcoroffsetcoefc)
        {
            ...
            if (FindFiledNameChannel(out i, "RXADCOROFFSCOEFC"))
            {
                ...
                try
                {
                    flag = CFP.SetCoef(deviceIndex, 1, DutStruct[i].StartAddress, rxadcoroffsetcoefc, DutStruct[i].Format, phycialAdress, 1);
                    logger.AdapterLogString(0, "SET RXADCOROFFSCOEFC To" + rxadcoroffsetcoefc);
                    return flag;
                }
                catch (Exception error)
                {
        ...
        {
            UInt16[] buff = new UInt16[1];
            buff = USBIO.ReadMDIO(deviceIndex, 1, phycialAdress, 0x8071, IOPort.MDIOSoftHard.SOFTWARE, 1);
            ...
            USBIO.WriteMDIO(deviceIndex, 1, phycialAdress, 0x8071, IOPort.MDIOSoftHard.SOFTWARE, buff);
       ...
       private bool SetDutTxPRBS(byte bprbsLength)
        {
            ...
            try
            {
                buff = USBIO.ReadMDIO(deviceIndex, 1, phycialAdress, 0xA011, IOPort.MDIOSoftHard.SOFTWARE, 1);
                ...
                switch (bprbsLength)
                {
                    ...
                    case 9://00
                        ...
                        USBIO.WriteMDIO(deviceIndex, 1, phycialAdress, 0xA011, IOPort.MDIOSoftHard.SOFTWARE, buff);
                        break;
                    case 15://01
       ...
       private bool SetDutRxPRBS(byte bprbsLength)
       {
           ...
           try
           {
               buff = USBIO.ReadMDIO(deviceIndex, 1, phycialAdress, 0xA012, IOPort.MDIOSoftHard.SOFTWARE, 1);
               ...
               switch (bprbsLength)
               {
                   ...
                   case 9://00
                       ...
                       USBIO.WriteMDIO(deviceIndex, 1, phycialAdress, 0xA012, IOPort.MDIOSoftHard.SOFTWARE, buff);
                       break;
                   case 15://01
        ...
        public  bool SetDutDataRate(string datarate)
        {
            ...
            buf = USBIO.ReadMDIO(deviceIndex, 1, phycialAdress, 0xA011, IOPort.MDIOSoftHard.SOFTWARE, 2);//A011:TX,A012:RX
            switch (datarate)
            {
                case "10.31":
                case "25":
            ...
            USBIO.WriteMDIO(deviceIndex, 1, phycialAdress, 0xA011, IOPort.MDIOSoftHard.SOFTWARE, buf);
            return true;
        }
        ...
        public override bool PinCtrl(CFPEVBPin pin, bool enable)
        {
            ...
            switch (pin)
            {
                ...
                default:
                    ...
                    logger.AdapterLogString(3,"Not define this pin ctrl");
                    return false;
            }
            USBIO.CFPCtrlNorPinBase(deviceIndex, cmd, rw, ddr, setdata, out getdata);
        ...
        public override bool SetBiasAdcOffset(UInt16 value)
        {
            ...
            if (algorithm.FindFileName(DutStruct, "BIASOFFSETADC", out i))
            {
                ...
                try
                {
                    flag = CFP.SetCoef(deviceIndex, 1, DutStruct[i].StartAddress, value.ToString(), DutStruct[i].Format, phycialAdress, 1);
                    logger.AdapterLogString(1, "SET BIASOFFSETADC To" + value);
                    return flag;
                }
                catch (Exception error)
                {
            ...
            {
                logger.AdapterLogString(4, "there is no BIASOFFSETADC");
                return true;
            }
        }
        ...
        { 
            ...
            if (algorithm.FindFileName(DutStruct, "BIASOFFSETADC", out i))
            {
                ...
                try
                {
                    biasOffsetAdc = CFP.readadc(deviceIndex, 1, DutStruct[i].StartAddress, phycialAdress, 1);
                    logger.AdapterLogString(1, "Current biasOffsetAdc is" + biasOffsetAdc);
                    return true;
