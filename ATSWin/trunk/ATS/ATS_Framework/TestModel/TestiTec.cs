...
namespace ATS_Framework
{
    public class TestITec : TestModelBase
    {
        ...
        #endregion
        #region Method
        public TestITec(DUT inPuDut, logManager logmanager)
        {
            logger = logmanager;
            dut = inPuDut;
            logoStr = null;
