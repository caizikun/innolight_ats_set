  ...
  public  class TestTxDmiPowCurve:TestModelBase
    {
        ...
        public TestTxDmiPowCurve(DUT inPuDut, logManager logmanager)
        {
            logger = logmanager;
            dut = inPuDut;
            logoStr = null;            
        ...
        protected override bool StartTest()
        {
            ...
            {                
                ...
                // open apc
                logoStr += logger.AdapterLogString(0, "Step1...Read DUT DmiTxPowCurveLT");
                txpProportionLessCoef = dut.GetTxpProportionLessCoef();
                logoStr += logger.AdapterLogString(1, "DmiTxPowCurveLT:" + txpProportionLessCoef.ToString());
                logoStr += logger.AdapterLogString(0, "Step2...Read DUT DmiTxPowCurveHT");
                txpProportionGreatCoef = dut.GetTxpProportionGreatCoef();
                logoStr += logger.AdapterLogString(1, "DmiTxPowCurveHT:" + txpProportionGreatCoef.ToString());
                OutPutandFlushLog();
                return true;
            }
            else
