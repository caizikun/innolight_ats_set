...
namespace ATS_Framework
{
    public class AdjustCrossing : TestModelBase
    {
        ...
        public AdjustCrossing(DUT inDut, logManager logmanager)
        {
            logger = logmanager;
            logoStr = null;
            dut = inDut;
        ...
        private bool AdjustMethodByBinarySearch()
        {
            ...
            try
            {
                ...
                {
                    logoStr += logger.AdapterLogString(4, "value is " + value);
                ...
                if (value >= mySpec.SpecMin && value <= mySpec.SpecMax)
                {
                    ...
                    logoStr += logger.AdapterLogString(1, "BestCrossingDAC=" + startDAC + " " + "BestCrossing=" + value.ToString());
                    return true;
                }
                else
                {
        ...
        private bool AdjustMethod_1()//
        {
            ...
            try
            {
                ...
                if (flag)
                {                    
                    logoStr += logger.AdapterLogString(1, "BestCrossingDAC=" + outDAC + " " + "BestCrossing=" + outCrossing.ToString());
                    return true;
                }
                else
                {
        ...
        //        else
        //        {
        //            logoStr += logger.AdapterLogString(1, "BestCrossingDAC=" + BestDac + " " + "BestCrossing=" + BestItemValue.ToString());
        //        }
        ...
        protected override bool AnalysisInputParameters(TestModeEquipmentParameters[] infoList)
        {
            ...
            {               
                ...
                if (isParaComplete)
                {
                    ...
                    {
                            logoStr += logger.AdapterLogString(4, "SpecMax_PR is wrong!");
                            return false;
                    }
                    else
                    {
                    ...
                    {
                        logoStr += logger.AdapterLogString(4, "SpecMin_PR is wrong!");
                        return false;
                    }
                    else
                    {
