...
#region  SFP28-LR-IT_CurveError
        ...
        public virtual bool SetTcase(string TempPoint, float Temp) { return false; }

        public virtual bool SetTE(string TempPoint, float TE) { return false; }
        public virtual bool SetSE(string TempPoint, float SE) { return false; }
        public virtual bool SetRatioOMA(string TempPoint, float Ratio_OMA) { return false; }
        public virtual bool SetRatioPf(string TempPoint, float Ratio_Pf) { return false; }
        public virtual bool SetIthNorm(string TempPoint, float IthNorm) { return false; }

        public virtual bool SetSeDiffTemp(string TempPoint, float IthNorm) { return false; }

        public virtual bool SetBiasCurrent(string TempPoint, float Current) { return false; }

      //  public virtual bool SetBiasDAC(string TempPoint, Int16 DAC) { return false; }
        public virtual bool SetModDAC(string TempPoint, Int16 DAC) { return false; }
