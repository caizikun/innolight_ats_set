...
namespace ATS
{
    public class ConfigXmlIO:XmlIO
    {
      ...
      override  public bool BuildXml()
        {
            ...
            AddElement(NodeEquipmentOffset, new XElement("LightSourceVecp", "0,0,0,0"));
      ...
      public string PWD
      {
        ...
        public string LightSourceVecp
        {
            set
            {
                ModifyElement(NodeEquipmentOffset, "LightSourceVecp", value);

            }
            get
            {
                return ReadElementValue(NodeEquipmentOffset, "LightSourceVecp");
            }
