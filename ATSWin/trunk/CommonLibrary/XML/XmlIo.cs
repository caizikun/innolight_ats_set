   ...
   public class XmlIO
    {
     ...
     virtual public bool BuildXml()
        ...
        virtual public bool BuildXml(RunRecordTableColums P)
     {
         return true;
     }
     /// <summary> 
     /// 创建节点,示例CreatNode("Node")
     /// </summary>
     ...
     /// <returns>bool</returns>
     /// 
     public XElement AddElement(XElement Node, string StrNodeName)
     {
         //XElement XmlLoadElment = XElement.Load(filePath);
         XElement db = null;
         try
         {
             db = new XElement(StrNodeName);
