    ...
    public class TPO4300 : Thermocontroller
    {
            ...
            try
            {
                switch (IOType)
                {
                    case "GPIB":
                        ...
                        EquipmentConnectflag = MyIO.ReadString().Contains("TEMPTRONIC");
        ...
        public override bool Configure(int syn = 0)
        {
            ...
            else
            {
                ...
                //AirFlowSetting();
                AirTempsUpperlimit("120",syn);
                AirTempslowerlimit("-60",syn);
        ...
        public override bool AirTempsUpperlimit(string ULIM,int syn = 0)
        {
            bool flag = false;
            bool flag1 = false;
            int k = 0;
        ...
        public override bool AirTempslowerlimit(string LLIM,int syn = 0)
        {
