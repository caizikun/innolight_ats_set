        ...
        public override bool Initialize(TestModeEquipmentParameters[] FLEX86100Struct)
        {
            try
            {
                ...
                if (algorithm.FindFileName(FLEX86100Struct,"FLEXOPTCHANNEL",out i))
                {
                    ...
                    if (strOpticalChannel.Length == 1)
                    {
                        strOpticalChannel = new string[4];
                        strOpticalChannel[0] = FlexOptChannel;
                        strOpticalChannel[1] = FlexOptChannel;
                        strOpticalChannel[2] = FlexOptChannel;
                        strOpticalChannel[3] = FlexOptChannel;
                    }
                }
                else
                {
      ...
      override public bool DisplayER()
      {
        ...
        private bool SaveEyeDiagram(string savePath, byte picColor, byte bgColor)
        {
            ...
            try
            {
                ...
                MyIO.WriteString(@":DISK:SIMage:FNAMe 'D:\User Files\screenshot.gif'");
        ...
        public override bool MeasureRxEyeVecEW(ref Dictionary<string,double> result, int syn = 0)
        {
            ...
            try
            {
                ...
                EyeTuningDisplay(0, 1);
                MyIO.WriteString(":ACQuire:REYE OFF");
                MyIO.WriteString(":ACQuire:RSPec RLENgth");
                MyIO.WriteString(":ACQuire:RLENgth:MODE MANual");
                MyIO.WriteString(":ACQuire:RLENgth 10000");
