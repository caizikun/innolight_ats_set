...
#region // GBIP order
       ...
       virtual public bool ConfigurePatternType(byte patternType, int syn = 0) { return true; }//0=PRBS,1=ZSUBstitution,2=DATA,3=ALT,4=MIXData,5=MIXalt,6=SEQuence
        virtual public bool ConfigurePrbsLength(byte prbsLength, int syn = 0) { return true; }


         virtual public bool DataPattern_DataLength(string length) { return true; }
         
         virtual public bool DataPattern_SetPatternData(string start, string end, string data){ return true; }

         virtual public bool RecallPrbsLength() { return true; }
         virtual public bool SetPPGDelay(double CurrentDelay,double OtherDelay) { return true; }
        ...
        //public virtual bool ConfigureTriggerDRatio() { return true; }
         virtual public bool GroupingSetting(bool isSync) { return true; }
