...
namespace ATS
{
    public class TestFormXml:XmlIO
    {
        ...
        struct XmlField
        {
            ...
            public XElement TestModelListNodel;// Condition Node
        }

        private XmlField MyXmlField = new XmlField();
        ...
        public TestFormXml(string StrPath)
        {
            ...
            MyXmlField.TestModelListNodel = XmlLoadElment.Element("TestModelList");
        ...
        public string DatabasePath = @"10.160.47.19\ATS_HOME";
        ...
        public bool FitEquipmentToXml(DataTable dt )
        {
            ...
            FitEquipmentInputParameterToXml("MAP200Atten", dt);
            FitEquipmentInputParameterToXml("MAP200OpticalSwitch", dt);
      ...
      /// <param name="dt">存放所有仪器参数的DataTable</param>
      /// <returns>元素节点</returns>
      public bool FitTestModelInfToXml( DataTable dt)
      {
        //  string StrNodeName = "TestModel";
          ...
          XElement myXElement;
          //  XElement myXElement0 = CreatNode(StrNodeName, StrItem, StrEqName);
           myXElement = CreatNode(MyXmlField.TestModelListNodel, "TestModel", StrItem, "TestTxEye");
           SelectCondition = "TestmodelName='" + "TestTxEye" + "'";
          drArray = dt.Select(SelectCondition);
          for (int i = 0; i < drArray.Length; i++)
          {
              AddElement(myXElement, new XElement(drArray[i]["ItemName"].ToString(), drArray[i]["itemValue"].ToString()));
          ...
          myXElement = CreatNode(MyXmlField.TestModelListNodel, "TestModel", StrItem, "TestBer");
          SelectCondition = "TestmodelName='" + "TestBer" + "'";
          drArray = dt.Select(SelectCondition);

          for (int i = 0; i < drArray.Length; i++)
          {
              string TempStr = drArray[i]["ItemName"].ToString().Replace("(", "_");
              TempStr = TempStr.Replace(")", " ").Trim();
              AddElement(myXElement, new XElement(TempStr, drArray[i]["itemValue"].ToString()));
          }
      ...
      public TestModeEquipmentParameters[] GetTestModelParameter(string StrTestModelName)
      {

          TestModeEquipmentParameters[] ParametersArray;

          XmlElement MyXmlElement = GetXmlNode(MyXmlField.TestModelListNodel, "TestModel", "Item", StrTestModelName);
      ...
      {
          XmlElement MyXmlElement = ToXmlElement(MyXmlField.ConditionListNodel);
