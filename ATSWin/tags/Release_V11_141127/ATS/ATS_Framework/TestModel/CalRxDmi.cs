...
{
  public  class CalRxDmi: TestModelBase
    {
#region Attribute
...
#endregion
#region Method
        public CalRxDmi(DUT inPuDut, logManager logmanager)
        {
            logger = logmanager;
            logoStr = null;
            dut = inPuDut;
        ...
        protected override bool StartTest()
        {
            ...
            if (selectedEquipList["ATTEN"] != null && selectedEquipList["DUT"] != null && selectedEquipList["POWERSUPPLY"] != null)
            {
                ...
                if (calRxDmiStruct.HasOffset == true)
                {
                    ...
                    dut.ReadRxpADC(out tempRxADC);
                    dut.SetRXPadcThreshold(Convert.ToByte(tempRxADC));
