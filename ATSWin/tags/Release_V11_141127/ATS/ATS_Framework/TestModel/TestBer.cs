...
#region Method
            ...
            if (selectedEquipList["ATTEN"] != null && selectedEquipList["ERRORDETE"] != null && selectedEquipList["DUT"] != null && selectedEquipList["POWERSUPPLY"] != null)
            {
                ...
                if (isAutoAlaign)
                {
                    ...
                    else
                    {
                        ...
                        attPoint = binarySearchTargetPoint(testBerStruct.CsenStartingRxPwr - testBerStruct.SearchTargetBerAddStep, testBerStruct.CsenStartingRxPwr + testBerStruct.SearchTargetBerSubStep, testBerStruct.SearchTargetBerLL, testBerStruct.SearchTargetBerUL, tempAtten, tempED, out serchAttPoints, out serchBerPoints);
        ...
        public double binarySearchTargetPoint(double LLimit, double ULimit, double targetBerLL, double targetBerUL, Attennuator tempAtt, ErrorDetector tempED, out ArrayList serchAttPoints, out ArrayList serchBerPoints)
        {
            double low = LLimit;
            double high = ULimit;
            double currentCense = 0;
