...
#region  委托声明
        ...
        private void button_Test_Click(object sender, EventArgs e)
        {
            ...
            if (FlagEquipmentConfigOK&&FlagEquipmentOffSetOK)
            {
                ...
                comboBoxPN.Enabled = false;
                comboBoxPType.Enabled = false;
                comboBoxTestPlan.Enabled = false;
                #endregion
                ...
                {
                    MessageBox.Show(ex.Message+"PLS Check the Connecter");
                    textBoxSN.Text = "";
                    textBoxSN.Refresh();
                    button_Test.Enabled = true;
                ...
                finally
                {
                    ...
                    if (textBoxSN.Text != "")
                    {
                        ...
                        pflowControl.MyDataio.WriterSN(pflowControl.TestPlanId, pflowControl.CurrentSN, pflowControl.CurrentFwRev,pflowControl.StrIpAddress, out pflowControl.SNID);
