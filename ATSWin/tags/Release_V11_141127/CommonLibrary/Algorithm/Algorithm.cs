  ...
  public  class Algorithm
    {
      ...
      /// <returns></returns>
             ...
             case "TR_CGR4_N00":
               {
                   ...
                   IBiasDAC = Convert.ToUInt32((iBiasMA - (IModDAC / 1023 * 48)) / 78 * 1023);
        ...
        public bool searchRealValue(double ibais, UInt32 ibiasdac, UInt32 imoddac, string serchStr, out string outStr)
        {
        ...
        public double Calculate(ArrayList bArray, double ibais, UInt32 ibiasdac, UInt32 imoddac)
        {
            ...
            for (int i = 0; i < aStr.Length; i++)
            {
                ...
                else //如果是操作符，就弹出两个数字来进行运算
                {
                    ...
                    if (searchRealValue(ibais, ibiasdac, imoddac, str1, out str1))
                    {
                    ...
                    if (searchRealValue(ibais, ibiasdac, imoddac, str2, out str2))
                    {
