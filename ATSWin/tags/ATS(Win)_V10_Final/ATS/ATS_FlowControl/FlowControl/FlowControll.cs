...
namespace ATS
{
   ...
   #region Interface
       ...
       // public bool ReadyforReadflag = false;
        ...
        public double CurrentTempOffset = 0;
      ...
      //  public CurrentTestModelEquipmentList MyCurrentTestModelEquipmentList;
        ...
        public DutEEPROMInitializeStuct[] Get_EEPROM_Init_FromSql()
        {
            ...
            string StrSelectconditions = "select * from " + StrTableName + " where PID= " + TestPlanId + " order by ID";
            DtMyDutInf = MyDataio.GetDataTable(StrSelectconditions, StrTableName);// 获得环境的DataTable
        ...
        public bool StartTest()
        {
           ...
           // QueueShow.Enqueue("Start Testing........");
            ...
            try
            {
                ...
                if (Flag_Need_EEPROMInitialize && pDut.EEpromInitStruct.Length > 0)
                {
                ...
                for (int ConditionSEQ = 0; ConditionSEQ < DtMyConditionDataTable.Rows.Count; ConditionSEQ++)//遍历测试环境条件
                {
                   ...
                   // ReadyforReadflag = false;
                    ...
                    CurrentTempOffset = Convert.ToDouble(drCondition["TempOffset"]);
                    ...
                    if (!pEnvironmentcontroll.ConfigEnvironmental(Convert.ToDouble(StrCurrentTemp), Convert.ToDouble(StrCurrentVcc), Convert.ToByte(CurrentChannel), StrEnvironmentAuxAttribles,CurrentTempOffset))// 设定当前的环境 以及告诉DUT 当前为通道几
                    {
...
#region 从当前ConditionTestData中挑选出错误项
        ...
        public bool RunTestModel(string StrTestModelName, String StrCurrentTestModelId)
        {
            ...
            try
            {
              ...
              //  flag_CurrentTestModel_FailBreak
                bool IsBreakflag=false;
                MyJudgeSpec.Judge(dtCurrentTestModelTestData, TestModelOutputArray, CurrentTestModelflag,flag_CurrentTestModel_FailBreak, out dtCurrentTestModelTestData, out IsBreakflag, out CurrentTestModelResultflag);
