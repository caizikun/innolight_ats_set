...
namespace ATS_Framework
{
    public class DUT:EquipmentBase
    {
        ...
        public bool FindFiledNameChannelDAC(out int i, string filedname)
        {
            ...
            do
            {
                if (DriverStruct[i].FiledName == filedname && DriverStruct[i].MoudleLine == MoudleChannel)
                {
                    break;
                }
                  i++;
        ...
        //add losd
        public virtual bool WriteLOSDDac(object losddac) { return false; }
        public virtual bool StoreLOSDDac(object losddac) { return false; }
