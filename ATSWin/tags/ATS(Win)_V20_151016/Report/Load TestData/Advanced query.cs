...
namespace Load_TestData
{
    public partial class Advanced_query : Form
    {
        ...
        {
            if ((comboBox1.SelectedItem == null) || (comboBox2.SelectedItem == null) || (comboBox3.Text == null))
            {
                MessageBox.Show("条件选择未完成");
            }
            else
            {
                string test = comboBox1.SelectedItem.ToString() + comboBox2.SelectedItem + comboBox3.Text;
