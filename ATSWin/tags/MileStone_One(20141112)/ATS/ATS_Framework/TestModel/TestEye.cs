 ...
 #region Method
        ...
        protected bool OpticalTest()
        {
            ...
            if (selectedEquipList["SCOPE"] != null && selectedEquipList["DUT"] != null)
            {
                ...
                logoStr += logger.AdapterLogString(1, "apWat:" + apWat.ToString());
        ...
        protected bool ElecTest()
        {
            ...
            if (selectedEquipList["SCOPE"] != null && selectedEquipList["DUT"] != null)
            {
                ...
                logoStr += logger.AdapterLogString(0, "apWat:" + apWat.ToString());
        ...
        protected override bool AnalysisOutputParameters(TestModeEquipmentParameters[] InformationList)
        {
            ...
            else//  InformationList is not null
            {
                ...
                for (byte i = 0; i < InformationList.Length; i++)
                {
                    ...
                    if (algorithm.FindFileName(InformationList, "TXOMA(UW)", out index))
                    {
                        InformationList[index].DefaultValue = Math.Round(apWat,4).ToString().Trim();
