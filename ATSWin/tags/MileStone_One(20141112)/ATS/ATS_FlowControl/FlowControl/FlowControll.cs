...
namespace ATS
{
    ...
    public class FlowControll// Flow Controll
    {
      ...
      //  public CurrentTestModelEquipmentList MyCurrentTestModelEquipmentList;
       ...
       // private int ProgressValue;
        ...
        public bool StartTest()
        {
           ...
           //if (StrAuxAttribles.ToUpper().Contains("OLDDRIVER=1"))
           //{
           //}
     ...
     Error:
                    ...
                    MyDataio.WriterLog(CurrentConditionId, SNID, StrSqlLog, StrStartTime, strEndTime, Convert.ToSingle(StrCurrentTemp), Convert.ToSingle(StrCurrentVcc), CurrentChannel, CurrentConditionResultflag, out CurrentLogId);
        ...
        public string[,]GetEquipmentNameList(int idTestplan)
        {
            ...
            for (i = 0; i < DT.Rows.Count; i++)
            {
             ...
             //   pEquipment[i,0]=DT.Rows[i]["ItemName"].ToString().ToUpper();
