...
#region Attribute
        ...
        private bool isLosA;
        private bool isLosD;
        private UInt32 losAMax;
        private UInt32 losDMin;
...
#region Method
       ...
       protected override bool StartTest()
       {
          ...
          if (tempAtt != null && tempps != null)
           {               
               ...
               {
                   logoStr += logger.AdapterLogString(1, "Set LosA RxPower:" + losAMax.ToString());
                   tempAtt.AttnValue(losAMax.ToString(),0);
               ...
               if (isParametersComplete)
               {
                   //for (byte i = 0; i < InformationList.Length; i++)
                   {
                       ...
                       if (algorithm.FindFileName(InformationList, "LOSA_DAC_START", out index))
                       {
                           ...
                           {
                               adjustLosStruct.LosAVoltageStartValue = Convert.ToUInt32(temp);
                           }
                       ...
                       if (algorithm.FindFileName(InformationList, "LOSA_DAC_MAX", out index))
                       {
                           ...
                           {
                               adjustLosStruct.LosAVoltageUperLimit = Convert.ToUInt32(temp);
                           }
                       ...
                       if (algorithm.FindFileName(InformationList, "LOSD_DAC_START", out index))
                       {
                           ...
                           {
                               adjustLosStruct.LosDVoltageStartValue = Convert.ToUInt32(temp);
                           }
                       ...
                       if (algorithm.FindFileName(InformationList, "LOSD_DAC_MAX", out index))
                       {
                           ...
                           {
                               adjustLosStruct.LosDVoltageUperLimit = Convert.ToUInt32(temp);
                           }
                       ...
                       if (algorithm.FindFileName(InformationList, "LOSD_DAC_MIN", out index))
                       {
                           ...
                           {
                               adjustLosStruct.LosDVoltageLowLimit = Convert.ToUInt32(temp);
                           }
       ...
       {          
           try
           {
               ...
               losAMax = Convert.ToUInt32(SpecTableStructArray[(byte)AdjustLosSpecs.LOSA].MaxValue);
               losDMin = Convert.ToUInt32(SpecTableStructArray[(byte)AdjustLosSpecs.LOSD].MinValue);
               return true;
           }
