    ...
    public class CFP4DUT : DUT
    {
        ...
        public override bool EEpromInitialize()
        {
            ...
            else
            {
                for (int i = 0; i < EEpromInitStruct.Length; i++)
                {
                    ...
                    UInt16[] WriteBiasDacByteArray = new UInt16[1];
                    WriteBiasDacByteArray[0] = (UInt16)(WriteeeArray[0]);
        ...
        public override bool ReadBiasDac(int length, out byte[] BiasDac)
        {
            ...
            if (FindFiledNameChannelDAC(out i, "BIASDAC"))
            {
                ...
                Engmod();
                UInt16 temp = MDIOReadDriver(deviceIndex, 1, startaddr, DriverStruct[i].RegisterAddress, DriverStruct[i].ChipLine, chipset);
                BiasDac[0] = (byte)(temp / 256);
                BiasDac[1] = (byte)(temp & 0xFF);
                return true;
            }
            else
            {
        ...
        public override bool ReadLOSDac(int length, out byte[] LOSDac)
        {
            ...
            if (FindFiledNameChannelDAC(out i, "LOSDAC"))
            {
                ...
                Engmod();
                UInt16 temp = MDIOReadDriver(deviceIndex, 1, startaddr, DriverStruct[i].RegisterAddress, DriverStruct[i].ChipLine, chipset);
                LOSDac[0] = (byte)(temp / 256);
                LOSDac[1] = (byte)(temp & 0xFF);
                return true;
            }
            else
            {
        ...
        public override bool ReadLOSDDac(int length, out byte[] LOSDDac)
        {
            ...
            if (FindFiledNameChannelDAC(out i, "LOSDDAC"))
            {
                ...
                Engmod();
                UInt16 temp = MDIOReadDriver(deviceIndex, 1, startaddr, DriverStruct[i].RegisterAddress, DriverStruct[i].ChipLine, chipset);
                LOSDDac[0] = (byte)(temp / 256);
                LOSDDac[1] = (byte)(temp & 0xFF);
                return true;
            }
            else
            {
        ...
        public override bool ReadAPDDac(int length, out byte[] APDDac)
        {
            ...
            if (FindFiledNameChannelDAC(out i, "APDDAC"))
            {
                ...
                Engmod();
                UInt16 temp = MDIOReadDriver(deviceIndex, 1, startaddr, DriverStruct[i].RegisterAddress, DriverStruct[i].ChipLine, chipset);
                APDDac[0] = (byte)(temp / 256);
                APDDac[1] = (byte)(temp & 0xFF);
                return true;
            }
            else
            {
        ...
        public override bool SetTxpcoefa(string Txpcoefa)
        {
            ...
            if (FindFiledNameChannel(out i, "DMITXPOWERCOEFA"))
            {
                ...
                try
                {
                    ...
                    logger.AdapterLogString(0, "SET DMITXPOWERCOEFA To" + Txpcoefa);
                    return flag;
                }
                catch (Exception error)
                {
        ...
        public override bool ReadTxpcoefa(out string strcoef)
        {
            strcoef = "";
            int i = 0;
        ...
        public override bool SetTxpcoefb(string Txpcoefb)
        {
            ...
            if (FindFiledNameChannel(out i, "DMITXPOWERCOEFB"))
            {
                ...
                try
                {
                    ...
                    logger.AdapterLogString(0, "SET DMITXPOWERCOEFB To" + Txpcoefb);
                    return flag;
                }
                catch (Exception error)
                {
        ...
        public override bool SetTxpcoefc(string Txpcoefc)
        {
            ...
            if (FindFiledNameChannel(out i, "DMITXPOWERCOEFC"))
            {
                ...
                try
                {
                    ...
                    logger.AdapterLogString(0, "SET DMITXPOWERCOEFC To" + Txpcoefc);
                    return flag;
                }
                catch (Exception error)
                {
