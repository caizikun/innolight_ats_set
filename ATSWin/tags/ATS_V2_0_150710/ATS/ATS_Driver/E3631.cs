    ...
    public class E3631: Powersupply
    {
        ...
        public override bool Initialize(TestModeEquipmentParameters[] PSStruct)
        {
            try
            {
                ...
                {
                    logger.AdapterLogString(4, "there is no DUTCHANNEL");
                    return false;
                }
                ...
                {
                    logger.AdapterLogString(4, "there is no OPTSOURCECHANNEL");
                    return false;
                }
                ...
                {
                    logger.AdapterLogString(4, "there is no DUTCURRENT");
                    return false;
                }
                ...
                {
                    logger.AdapterLogString(4, "there is no OPTVOLTAGE");
                    return false;
                }
                ...
                {
                    logger.AdapterLogString(4, "there is no OPTCURRENT");
                    return false;
                }
                ...
                {
                    logger.AdapterLogString(4, "there is no VOLTAGEOFFSET");
                    return false;
                }
                ...
                {
                    logger.AdapterLogString(4, "there is no CURRENTOFFSET");
                    return false;
                }
            ...
            try
            {
                ...
                switch (IOType)
                {
                    case "GPIB":
                        ...
                        EquipmentConnectflag = MyIO.ReadString().Contains("E3631");
                        break;
                    default:
        ...
        public override bool ConfigVoltageCurrent(string voltage)
        {
            ...
            {
                flag = MyIO.WriteString(Str_Write);
                logger.AdapterLogString(3, "E3631 channel is" + str_channel + "voltage is" + volandoffset + "current is" + DutCurrent);
                return flag;
