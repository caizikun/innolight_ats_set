...
namespace ATS_Driver
{
    public class SFP28DUT : DUT
    {
        ...
        public  byte[] ReadDriver10g(int deviceIndex, int deviceAddress, int StartAddress, int regAddress,byte chipset)
        {
        ...
        {
            return sfp.ReadWriteDriverSFP(deviceIndex, deviceAddress, StartAddress, regAddress, 0x04, chipset, dataToWrite);
        }
        ...
        public override bool WriteLOSDac(object losdac)
        {
            ...
            if (FindFiledNameChannelDAC(out i, "LOSDAC"))
            {
                ...
                Engmod(engpage);
                WriteDriver10g(deviceIndex, 0xA2, startaddr, DriverStruct[i].RegisterAddress, chipset, WriteLOSDacByteArray);
                return true;
            }
            else
            {
        ...
        public override bool WriteAPDDac(object apddac)
        {
            ...
            if (FindFiledNameChannelDAC(out i, "APDDAC"))
            {
                ...
                Engmod(engpage);
                WriteDriver10g(deviceIndex, 0xA2, startaddr, DriverStruct[i].RegisterAddress, chipset, WriteAPDDacByteArray);
                return true;
            }
            else
            {
        ...
        public override bool StoreCrossDac(object crossdac)
        {
            ...
            if (FindFiledNameChannelDAC(out i, "CROSSDAC"))
            {
                ...
                Engmod(engpage);
                StoreDriver10g(deviceIndex, 0xA2, startaddr, DriverStruct[i].RegisterAddress, chipset, StoreBiasDacByteArray);
                return true;
            }
            else
            {
        ...
        public override bool StoreModDac(object moddac)
        {
            ...
            if (FindFiledNameChannelDAC(out i, "MODDAC"))
            {
                ...
                Engmod(engpage);
                StoreDriver10g(deviceIndex, 0xA2, startaddr, DriverStruct[i].RegisterAddress, chipset, StoreModDacByteArray);
                return true;
            }
            else
            {
        ...
        public override bool StoreLOSDac(object losdac)
        {
            ...
            if (FindFiledNameChannelDAC(out i, "LOSDAC"))
            {
                ...
                Engmod(engpage);
                StoreDriver10g(deviceIndex, 0xA2, startaddr, DriverStruct[i].RegisterAddress, chipset, StoreLOSDacByteArray);
                return true;
            }
            else
            {
        ...
        public override bool StoreAPDDac(object apddac)
        {
            ...
            if (FindFiledNameChannelDAC(out i, "APDDAC"))
            {
                ...
                Engmod(engpage);
                StoreDriver10g(deviceIndex, 0xA2, startaddr, DriverStruct[i].RegisterAddress, chipset, StoreAPDDacByteArray);
                return true;
            }
            else
            {
        ...
        public override bool ReadCrossDac(int length, out byte[] crossdac)
        {
            ...
            if (FindFiledNameChannelDAC(out i, "CROSSDAC"))
            {
                ...
                Engmod(engpage);
                crossdac = ReadDriver10g(deviceIndex, 0xA2, startaddr, DriverStruct[i].RegisterAddress, chipset);
                return true;
            }
            else
            {
        ...
        public override bool ReadBiasDac(int length, out byte[] BiasDac)
        {
            ...
            if (FindFiledNameChannelDAC(out i, "BIASDAC"))
            {
                ...
                Engmod(engpage);
                BiasDac = ReadDriver10g(deviceIndex, 0xA2, startaddr, DriverStruct[i].RegisterAddress, chipset);
                return true;
            }
            else
            {
        ...
        public override bool ReadModDac(int length, out byte[] ModDac)
        {
            ...
            if (FindFiledNameChannelDAC(out i, "MODDAC"))
            {
                ...
                Engmod(engpage);
                ModDac = ReadDriver10g(deviceIndex, 0xA2, startaddr, DriverStruct[i].RegisterAddress, chipset);
                return true;
            }
            else
            {
        ...
        public override bool ReadLOSDac(int length, out byte[] LOSDac)
        {
            ...
            if (FindFiledNameChannelDAC(out i, "LOSDAC"))
            {
                ...
                Engmod(engpage);
                LOSDac = ReadDriver10g(deviceIndex, 0xA2, startaddr, DriverStruct[i].RegisterAddress, chipset);
                return true;
            }
            else
            {
        ...
        public override bool ReadLOSDDac(int length, out byte[] LOSDDac)
        {
            ...
            if (FindFiledNameChannelDAC(out i, "LOSDDAC"))
            {
                ...
                Engmod(engpage);
                LOSDDac = ReadDriver10g(deviceIndex, 0xA2, startaddr, DriverStruct[i].RegisterAddress, chipset);
                return true;
            }
            else
            {
        ...
        public override bool ReadAPDDac(int length, out byte[] APDDac)
        {
            ...
            if (FindFiledNameChannelDAC(out i, "APDDAC"))
            {
                ...
                Engmod(engpage);
                APDDac = ReadDriver10g(deviceIndex, 0xA2, startaddr, DriverStruct[i].RegisterAddress,chipset);
                return true;
            }
            else
            {
