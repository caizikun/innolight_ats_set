  ...
  public  class Algorithm
    {
      ...
      /// <returns></returns>
        ...
        public object AnalyticalExpression(string expression, double ibaisorimod, UInt32 ibiasdac = 0, UInt32 imoddac = 0)
        {
        ...
        public SpecTableStruct[] FindDataInDataTable(DataTable inputDT, SpecTableStruct[] inputSList)
        {
            string selectStr1 = "";           
            DataRow[] drData;
            ...
            try
            {
                ...
                {
                    selectStr1 = "FullName='" + inputSList[i].ItemName+"'";
